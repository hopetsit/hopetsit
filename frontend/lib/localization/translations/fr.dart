...
const Map<String, String> frFRTranslations = <String, String>{
      ...
      'guest_iwant': 'Je veux…',
      'guest_role_owner_sub': 'Je cherche un pet sitter ou un promeneur de confiance.',
      'guest_role_sitter_sub': 'Je garde des animaux et je gagne de l\'argent en toute sécurité.',
      'guest_role_walker_sub': 'Je promène des chiens et je gagne de l\'argent près de chez moi.',
