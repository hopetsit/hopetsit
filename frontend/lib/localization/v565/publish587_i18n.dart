// v587 (point 8 de Daniel) — LIEU DU SERVICE dans « Publier une annonce », 9 langues.
...
// Les libellés `svc587_show_*` sont NEUTRES (lus par le propriétaire ET le
// prestataire) : carte d'annonce, fiche de réservation, bulle PawMap.
// Enregistré dans `v565_i18n.dart`.
const Map<String, Map<String, String>> publish587I18n = <String, Map<String, String>>{
  'en': <String, String>{
