...
const Map<String, String> enUSTranslations = <String, String>{
      ...
      'unit_week': 'week',
      'unit_month': 'month',
      'signup_city_detected': 'Your city',
      'signup_change_city': 'Change',
      'guest_near_title': 'Sitters near you',
      'guest_latest': 'Latest members',
      'guest_filter_all': 'All',
      'guest_see_all': 'See all',
      'guest_about': 'About',
      'guest_services': 'Services & rates',
      'login_or_email': 'or with your email',
      'login_remember': 'Remember me',
      'login_resume': 'Resume',
      'login_last_session': 'last session',
      'login_new': 'New here?',
      'login_create': 'Create an account',
      'guest_hero_title_1': 'The best for your',
      'guest_hero_title_2': 'companion',
      'guest_already': 'Already have an account?',
      'guest_role_guest_sub': 'I\'m exploring without an account.',
      'guest_role_guest': 'Guest',
      'guest_badge_trust': 'A community you can trust',
      'guest_hero_title': 'The best for your companion',
      'guest_hero_sub': 'Find a trusted pet sitter or dog walker near you.',
      'guest_feat_verified': 'Verified profiles',
      'guest_feat_verified_sub': 'Identity checks',
      'guest_feat_gps': 'Real-time GPS',
      'guest_feat_gps_sub': 'Track every walk',
      'guest_feat_pay': 'Secure payment',
      'guest_feat_pay_sub': '100% protected',
      'guest_feat_chat': 'Built-in chat',
      'guest_feat_chat_sub': 'Chat with ease',
      'guest_iwant': 'I want to…',
      'guest_role_owner_sub': 'I\'m looking for a trusted sitter.',
      'guest_role_sitter_sub': 'I pet-sit safely and get paid.',
      'guest_role_walker_sub': 'I walk dogs near my home.',
      'guest_discover_btn': 'Discover sitters near you',
      'guest_create_sub': 'Fast, free and secure',
      'guest_continue_apple': 'Continue with Apple',
      'guest_continue_google': 'Continue with Google',
      'guest_signup_email': 'Sign up with my email',
      'guest_terms_note': 'By creating an account, you agree to our Terms of Use and Privacy Policy.',
      'guest_tab_map': 'Map',
      'guest_tab_list': 'List',
      'guest_tab_requests': 'Requests',
      'guest_verified': 'Verified',
      'guest_from_price': 'From @price',
      'guest_respond': 'Respond',
      'guest_no_requests': 'No requests yet — check back soon!',
      ...
      'guest_wall_subtitle': 'Free, takes less than a minute. Verified profiles, secure payments.',
      'guest_wall_signup': 'Sign up',
      'guest_wall_login': 'I already have an account',
      'pawspot_share': 'Share this place',
      'pawspot_share_message': 'I found @name on HoPetSit — a great spot for our pets:',
      'pawspot_share_copied': 'Link copied',
      'handover_owner_code_title': 'Handover code',
      'handover_owner_code_desc': 'Give it to the provider when you hand over your pet.',
      'handover_owner_code_copied': 'Code copied',
      'handover_pickup_title': 'Picking up the pet',
      'handover_pickup_desc': 'Take a photo of the pet and enter the 4-digit code the owner gives you.',
      'handover_return_title': 'Returning the pet',
      'handover_return_desc': 'Take a photo of the pet as you hand it back — it is your proof if anything is disputed.',
      'handover_take_photo': 'Take a photo',
      'handover_from_gallery': 'Choose from gallery',
      'handover_remove_photo': 'Remove photo',
      'handover_code_label': 'Owner\'s code',
      'handover_code_hint': 'The owner can see this code in their app.',
      'handover_confirm_pickup': 'Confirm pickup',
      'handover_confirm_return': 'Confirm return',
      ...
      'pawmap_expand_short': 'Enlarge',
      'pawmap_reduce_map': 'Reduce',
      ...
      'publish_end_time_same_day': 'End time (same day)',
      'friends_pending': 'Pending…',
      'walker_not_found': 'Walker not found',
      'walker_load_error': 'Unable to load the walker\'s profile.',
      'signup_as_subtitle': 'Choose your account type to get started.',
      'email_verif_title': 'Email verification',
      'email_verif_enter_code': 'Enter the verification code sent to',
      'email_verif_resend_in': 'Resend code in: ',
      'kyc_identity_title': 'Identity verification',
      'add_card_auto_saved': 'Card saved automatically',
      ...
      'friend_request_banner_title': 'New friend request',
      'friend_request_banner_subtitle': '@name wants to add you as a friend',
      'friend_request_view_profile': 'View profile',
      'friend_request_declined_msg': 'Friend request declined.',
      'band_service_start_title': 'It\'s time!',
      'band_service_start_subtitle': 'Confirm the start of the service for @pet',
      'band_service_end_title': 'Service in progress',
      'band_service_end_subtitle': 'Returned @pet? Confirm the end of the service',
      'band_owner_confirm_title': 'Confirm the end of the service',
      'band_owner_confirm_subtitle': '@name has finished — confirm to release the payment',
      'band_cta_start': 'Start',
      'band_cta_end': 'Finish',
      'band_cta_confirm': 'Confirm',
      'band_provider_fallback': 'The provider',
      'band_owner_pay_title': '@name accepted!',
      'band_owner_pay_title_extra': '@name accepted! (+@count)',
      'band_cta_pay': 'Pay @amount',
      'band_cta_pay_all': 'Pay all @amount',
      'band_payment_made_title_extra': 'Payment made (+@count)',
      'band_payment_pending_title': 'Payment pending!',
      'band_payment_pending_subtitle': 'Confirm your payment before it expires.',
      'band_cta_pay_now': 'Pay now',
      'band_new_request_title': 'New request!',
      'band_new_request_subtitle': '@owner • @pet • @date → @amount estimated',
      ...
      'pawmap_me_label': 'Me',
      'pawspot_type_short_path_walk': 'Path',
      'pawspot_type_short_chill': 'Chill',
      'pawspot_type_short_playground': 'Playground',
      'pawspot_type_short_swimming': 'Swimming',
      'pawspot_type_short_food_cafe': 'Food',
      'pawspot_type_short_other': 'Other',
      'pawspot_pick_hint': 'Move the map to place the red dot on the exact spot',
      'pawspot_pick_confirm': 'Validate the spot',
      ...
      'pawfollow_feature_live_toggle': 'Long live sharing: 2 h per session, even with the app closed, with your walk history',
      'pawmap_tag_spot_btn': 'Tag a spot',
      'pawmap_view_spots_btn': 'View spots',
      'pawmap_view_reports_btn': 'View reports',
      'pawspot_legend_title': 'Spot types',
      'pawspot_list_title': 'Nearby PawSpots',
      'pawspot_list_empty': 'No PawSpot here yet — tag the first one!',
      'pawmap_my_points_chip': 'My PawPoints: @points',
      'pawspot_type_path_walk': 'Path / Walk',
      'pawspot_type_chill': 'Chill / Relax',
      'pawspot_type_playground': 'Playground',
      'pawspot_type_swimming': 'Swimming',
      'pawspot_type_food_cafe': 'Pet-friendly café / food',
      'pawspot_type_other': 'Other',
      'pawspot_add_title': 'Add a PawSpot',
      'pawspot_add_type_label': 'Spot type',
      'pawspot_add_type_hint': 'Select a type',
      'pawspot_add_name_label': 'Spot name',
      'pawspot_add_name_hint': 'E.g. Great forest walk',
      'pawspot_add_desc_label': 'Description',
      'pawspot_add_desc_hint': 'Describe your spot…',
      'pawspot_add_photo': 'Add a photo',
      'pawspot_publish_btn': 'Publish the PawSpot',
      'pawspot_published_msg': 'PawSpot published! +@points PawPoints',
      'pawspot_limit_reached': 'Free account: up to 3 PawSpots. Subscribe to PawSpot for unlimited tagging.',
      'pawspot_added_by': 'Added by @name',
      'pawspot_go_btn': 'Go there',
      'pawspot_directions_btn': 'Directions',
      'pawspot_quality': 'Quality',
      'pawspot_validations': 'Validations',
      'pawspot_visits': 'Visits',
      'pawspot_validate_btn': 'Validate this spot',
      'pawspot_validated_badge': 'Community validated',
      'pawspot_comments_title': 'Comments',
      'pawspot_comment_hint': 'Add a comment…',
      'pawspot_delete_confirm': 'Delete this PawSpot?',
      'pawspot_subscribe_required': 'PawSpot subscription required',
      'directions_subscription_required': 'Directions are included in PawFollow, PawFamily and PawSpot.',
      'directions_loading': 'Calculating route…',
      'directions_clear': 'Clear route',
      'pawspot_shop_subtitle': 'Tag, share and discover the best pet-friendly spots',
      'pawspot_plan_monthly': 'Monthly',
      'pawspot_plan_yearly': 'Yearly',
      'pawspot_save_badge': 'SAVE 33%',
      'pawspot_trial_btn': '7-day free trial',
      'pawspot_trial_used': 'Trial already used',
      'pawspot_trial_started': 'PawSpot trial activated for 7 days!',
      'pawspot_feature_unlimited': 'Unlimited spot tagging',
      'pawspot_feature_all': 'Access to all PawSpots',
      'pawspot_feature_top': 'See popular spots',
      'pawspot_feature_points_badges': 'PawPoints on every contribution + community badges',
      'pawspot_feature_rewards': 'Point rewards',
      'pawspot_active_until': 'PawSpot active · @days d left',
      'pawspot_points_title': 'My PawPoints',
      'pawpoints_rewards_cta': 'See rewards',
      'pawpoints_perk_badge': 'Exclusive badge',
      'pawpoints_perk_chests': 'Access to basic chests',
      'pawpoints_perk_map': 'Visibility on the map',
      'pawpoints_perk_bonus5': 'Bonus points +5%',
      'pawpoints_perk_bonus10': 'Bonus points +10%',
      'pawpoints_perk_boost': 'Free PawBoost',
      'pawpoints_perk_frame': 'Legendary frame',
      'pawpoints_perk_status': 'Legendary status',
      'pawpoints_perk_crown': 'Pink crown',
      'pawpoints_perk_ultimate': 'Ultimate perks',
      'pawpoints_already_claimed': 'Already used',
      'pawpoints_applied_now': 'Subscription credited!',
      'pawpoints_applied_next': 'Discount applied to your next purchase',
      'pawpoints_sub_rewards_title': 'Subscription discounts',
      'pawpoints_sub_rewards_sub': 'Exchange your points for discounts or free months.',
      'pawpoints_levels_title': 'Levels & exclusive tiers',
      'pawpoints_levels_sub': 'The more you contribute, the more rewards you unlock.',
      'pawpoints_stat_contributions': 'Contributions',
      'pawpoints_stat_liked': 'Liked spots',
      'pawpoints_stat_level': 'Level',
      'pawpoints_stat_points': 'Points',
      'pawpoints_to_next': '@pts pts to reach @level',
      'pawpoints_max_level': 'Max level reached',
      'pawpoints_bonus_active': 'Bonus active: +@pct% PawPoints',
      'pawpoints_3m_free': '3 FREE months',
      'pawpoints_1m_free': '1 FREE month',
      'pawpoints_once': 'Valid once',
      'pawpoints_used': 'Used',
      'pawpoints_legend_title': 'Reach @pts points to become Paw Legend',
      'pawpoints_legend_sub': 'A unique status on your profile + the most exclusive perks.',
      'pawpoints_legend_remaining': '@pts pts to go',
      ...
      'pawpoints_redeem': 'Redeem',
      'pawpoints_locked': 'Locked',
      'pawpoints_sold_out': 'Sold out',
      'pawspot_points_how_title': 'Earn points',
      'pawspot_points_add': '+10: add a PawSpot',
      'pawspot_points_photo': '+5: photo added',
      'pawspot_points_validated': '+10: community-validated spot',
      'pawspot_points_comment': '+2: useful comment',
      'pawspot_points_report': '+1: correct report',
      'pawspot_points_popular': '+25: very popular spot (50)',
      'pawspot_badges_title': 'Badges',
      'pawspot_badge_explorer': 'Explorer · 100 pts',
      'pawspot_badge_expert': 'Expert · 500 pts',
      'pawspot_badge_ambassador': 'Ambassador · 1,500 pts',
      'pawspot_badge_pawmaster': 'PawMaster · 5,000 pts',
      'pawspot_badge_gold_creator': 'Gold Creator (1,000 pts): your spots get the GOLDEN paw',
      'pawspot_next_badge': 'Next badge: @badge at @points pts',
      'pawspot_leaderboard_title': 'Leaderboard',
      'pawspot_lb_city': 'My city',
      'pawspot_lb_country': 'Country',
      'pawspot_lb_europe': 'Europe',
      'pawspot_rewards_title': 'Premium rewards',
      'pawspot_rewards_catalog_hint':
          'Redeem your PawPoints for the catalog rewards (updated regularly).',
      'pawspot_reward_feature': 'Feature a spot for 7 days (50 pts)',
      'pawspot_reward_badge_color': 'Badge color (100 pts)',
      'pawspot_reward_banner': 'Custom banner (150 pts)',
      'pawspot_reward_gold_frame': 'Gold profile frame (200 pts)',
      'pawspot_reward_redeemed': 'Reward unlocked!',
      'pawspot_profile_tile': 'PawPoints & badges',
      'pawspot_profile_tile_sub': 'Points, leaderboard and rewards',
      ...
      'family_invitation_banner_subtitle': '@name wants to add you to their PawFollow Family',
      'family_invitation_declined_msg': 'Family invitation declined.',
      ...
      'pawmap_quick_circle_sub': 'See members',
      ...
      'route_steps_btn': 'Steps',
      'route_steps_title': 'Turn-by-turn directions',
      ...
      'poi_hours_label': 'Opening hours',
      'poi_call': 'Call',
      'send_request_walk_datetime_label': 'Walk date and time',
      'send_request_end_auto_hint': 'The end time is calculated from the duration you pick below.',
      'send_request_end_auto_value': 'Automatic end: {time} ({min} min)',
      'sitter_app_summary_bookings': 'Bookings',
      'sitter_app_empty_all': 'No applications or bookings yet',
      'sitter_app_empty_filter': 'No results for this filter',
      'friends_deleted_user': 'Deleted user',
      'friends_accepted_title': 'Accepted',
      'friends_accepted_msg': 'You are now friends.',
      'deeplink_expired_msg': 'Link expired. Try again from the website.',
      'payment_airwallex_title': 'Payments now go through Airwallex',
      'payment_airwallex_hint': 'Go back to the previous screen and start your purchase again: a new payment form will open.',
      'payment_secure_title': 'Secure payment',
      'payment_airwallex_pci': 'Payment is processed by Airwallex (PCI-DSS Level 1). Your card details never pass through HoPetSit.',
      'add_card_airwallex_hint': 'With Airwallex your card is saved automatically at your first payment. No need to add it in advance.',
      'auth_choose_account_type_msg': 'Choose your account type (owner, sitter or walker).',
      'payout_setup_title': 'Payout setup',
      'payout_setup_msg': 'Enter your IBAN in Profile → Bank account to receive your payouts.',
      'pet_emergency_consent_text': 'I authorise the pet sitter to contact the emergency vet and to arrange the necessary care in case of a life-threatening situation for my pet, with costs at my expense. I remain reachable at all times.',
      'pawmap_request_default_title': 'Care request',
      'price_days_one': '1 day',
      'price_days_n': '{n} days',
      'price_month_one': '1 month',
      'price_week_one': '1 week',
      ...
      // v208 fix : clé 'friends_tab_requests' existait déjà ligne 496,
      ...
      // v23.1 part 211 — Alerts page redesign (mockup Daniel)
      'alerts_chip_radius': 'Around me · @km km',
      'alerts_filter_title': 'Filters',
      'alerts_filter_radius_title': 'Search radius',
      'alerts_filter_period_title': 'Period',
      'alerts_search_title': 'Search',
      'alerts_search_hint': 'Animal, place, type...',
      'alerts_period_24h': 'Last 24 hours',
      'alerts_period_48h': 'Last 48 hours',
      'alerts_period_7d': 'Last 7 days',
      'alerts_period_30d': 'Last 30 days',
      'alerts_what_can_you_do': 'What can you do?',
      'alerts_action_see_nearby': 'See nearby alerts',
      'alerts_action_widen': 'Widen the search',
      'alerts_action_enable_notifs': 'Enable notifications',
      'alerts_signal_lost_title': 'Report a lost pet',
      'alerts_signal_lost_subtitle': 'Help find a companion',
      'alerts_info_community_title': 'Active community',
      'alerts_info_community_msg': 'Thousands of people are watching',
      'alerts_info_nearby_title': 'Nearby alerts',
      ...
      'alerts_diagnose_tooltip': 'Alerts diagnostic',
      'alerts_diagnose_title': 'Alerts diagnostic',
      'alerts_diagnose_failed': 'Could not retrieve diagnostic.',
      'common_clear': 'Clear',
      ...
      'report_cat_vet_open': 'Vet open',
      'map_report_label_vet_open': 'Vet open',
      'map_report_hint_vet_open': 'Open or on-call vet spotted here',
      'report_cat_leash_required': 'Leash required',
      'map_report_label_leash_required': 'Leash required',
      'map_report_hint_leash_required': 'Area where a leash is required',
      'report_cat_heat_hot_ground': 'Hot ground',
      'map_report_label_heat_hot_ground': 'Hot ground',
      'map_report_hint_heat_hot_ground': 'Hot ground / heatwave, danger for paws',
      'report_cat_tick_zone': 'Tick zone',
      'map_report_label_tick_zone': 'Tick zone',
      'map_report_hint_tick_zone': 'Tall grass / ticks and parasites',
      ...
      'premium_signals_note': 'Any active subscription (PawFollow, PawFamily, PawSpot or Paw Premium) unlocks ALL premium reports.',
      ...
      'friends_pending_banner_cancelled_title': 'Request canceled',
      ...
      'profile_days_active': 'active days',
      'profile_status_available_walk': 'Available · Walking',
      'profile_status_available_sit': 'Available · Home sitting',
      ...
      'chat_gate_title': 'Chat locked for now',
      'chat_gate_body': 'The chat opens once the service is paid, or with an active subscription (PawFollow, PawSpot or PawPremium). This keeps bookings and payments safe.',
      'chat_gate_shop': 'See subscriptions',
      'chat_share_phone_button': 'Share my phone',
      'phone_share_title': 'Phone number',
      'pawmap_sub_required_title': 'Subscription required',
      'pawmap_sub_required_msg': 'This feature requires an active subscription.',
      'pawmap_see_offers': 'See plans',
      'pawmap_later': 'Later',
      'pawmap_toggle_info_title': 'Map display',
      'pawmap_toggle_info_chip': 'About ON/OFF',
      'pawmap_toggle_info': 'The ON/OFF button only affects the map display. Your subscription stays active even when this option is turned off.',
      'phone_share_subtitle': 'Number shared in the chat',
      'phone_share_call': 'Call',
      'phone_share_copy': 'Copy',
      'phone_share_copied': 'Number copied',
      'phone_share_confirm_title': 'Share my phone number?',
      'phone_share_confirm_msg': 'Your phone number will be visible to the other person in the conversation.',
      'phone_share_sent_title': 'Number sent',
      'phone_share_sent_msg': 'Your number has been shared in the chat.',
      'phone_share_no_profile_title': 'Missing number',
      'phone_share_no_profile_msg': 'Add a phone number to your profile before sharing it.',
      ...
      // v441 — appearance + app-language selectors under "Edit profile"
      'pref_appearance': 'Appearance / Theme',
      ...
      'chat_locked_dialog_title': 'Chat locked',
      'chat_locked_dialog_desc':
          'To chat freely with friends and between bookings, activate one of the two plans:',
      'chat_locked_dialog_premium_title': 'Premium',
      'chat_locked_dialog_premium_sub':
          'Chat with everyone + all features.',
      'chat_locked_dialog_addon_title': 'Chat add-on (~€0.99/month)',
      'chat_locked_dialog_addon_sub':
          'Unlocks chat only, renews every 30 days.',
      'chat_locked_dialog_later': 'Later',
      'chat_locked_dialog_open_shop': 'Open the Shop',
      ...
      'address_share_title': 'Pickup address',
      'address_share_subtitle': 'Where to pick up the pet',
      'address_share_open_directions': 'Directions',
      'address_share_empty': 'No address on profile — add one to share it.',
      'address_share_button': 'Share my address',
      'address_share_sent_title': 'Address sent',
      'address_share_sent_msg': 'The address has been shared in the chat.',
      'address_share_no_profile_title': 'Missing address',
      'address_share_no_profile_msg': 'Add an address in your profile before sharing it.',
      'friend_block': 'Block',
      ...
      // v23.1 part 251 — add family member from friends list.
      'family_add_from_friends': 'From my friends',
      'family_add_from_friends_sub': 'Pick a friend to add',
      'family_add_from_friends_empty': 'No friend available to add. Add friends first, or invite by name/email.',
      'family_invite_sent_title': 'Invitation sent',
      'family_invite_sent_msg': 'Invitation sent to @name.',
      'family_invite_btn': 'Invite',
      'family_already_member': 'This person is already part of your family.',
      ...
      'leaderboard_empty_title': 'The leaderboard is still empty',
      'leaderboard_empty_subtitle': 'Earn PawPoints by adding places, reports and reviews on the PawMap: the first contributors will appear here.',
      ...
      'sitter_app_status_cancelled': 'Canceled',
      ...
      'top_sitter_need_bookings': '@bookings more services · rating ✓',
      ...
      'referrals_how_it_works': 'For every friend who signs up with your code and completes their first booking, you get -10% off your next PawFollow or PawFamily plan.',
      'referrals_discounts_available': '@count discount(s) of -10% available on PawFollow/PawFamily',
      ...
      'onboarding_svc_petsitting_d': 'Trusted sitting & walking',
      'onboarding_svc_pawmap_d': 'Pet-friendly places in Europe',
      'onboarding_svc_pawfollow_d': 'Real-time tracking',
      'onboarding_svc_pawspot_d': 'Community of spots',
      ...
      'coin_shop_pawspot_summary_fallback': 'PawSpot is using your home address. Pick a specific location to stand out on the map.',
      ...
      'signup_error_email_taken': 'An account already exists with this email. Log in instead.',
      'signup_error_too_many': 'Too many attempts. Please wait a minute and try again.',
      'common_error_no_network': 'No internet connection. Check your network and try again.',
      'signup_error_city_required': 'Choose your city so we can show what is around you.',
      'signup_error_service_required': 'Select at least one service.',
      'signup_error_animals_required': 'Select at least one animal you accept.',
      'signup_error_rate_required': 'Enter at least one rate so owners can book you.',
      ...
      'owner_profile_about': 'About me',
      'owner_profile_pets': 'Their pets',
      ...
      'shop_pb_free_title': 'Free for everyone',
      'shop_pp_plus_body': 'Everything in PawFollow and PawSpot, all premium reports, instant notifications, unlimited chat, crown on your profile. Cheaper than both separately.',
      'shop_pp_plus_title': 'With PawPremium',
      'shop_pp_free_body': 'Free reports (lost pet, found pet, water point, vet open) and real-time alerts around you.',
      'shop_pp_free_title': 'Free for everyone',
      'shop_ps_plus_body': 'Unlimited tags, popular spots, badges and rewards, directions included, 20 premium reports.',
      'shop_ps_plus_title': 'With PawSpot',
      'shop_ps_free_body': 'See every PawSpot and community place, tag your first 3 spots, earn PawPoints.',
      'shop_ps_free_title': 'Free for everyone',
      ...
      'shop_pf_free_body': 'Share your live position with friends (30 min per session, app open) and follow your walker or sitter during the service.',
      'shop_pf_free_title': 'Free for everyone',
      'pawmap_live_free_cap_msg': 'Sharing stopped after 30 min (free session). With PawFollow: 2 h, even with the app closed, plus directions and history.',
      'pawspot_photo_uploading': 'Uploading the photo…',
      'pawmap_pick_title_spot': 'Place a Paw Spot',
      'pawmap_pick_title_report': 'Place a report',
      'pawmap_pick_title_route': 'Directions to this point',
      'pawmap_pick_locating': 'Finding the address…',
      'pawmap_route_pick_hint': 'Move the map onto your destination, then confirm',
      'pawmap_search_recent': 'Recent searches',
      'pawmap_refresh_done': 'Map updated',
      ...
      'pawmap_lost_seen_btn': 'I saw this animal',
      'pawmap_lost_help_hint': 'Spotted this lost animal? Confirm here — the owner is notified and the alert extended. It\'s free.',
      'pawmap_lost_seen_thanks': 'Thank you! The owner has been notified and the alert extended.',
      ...
      'pawmap_filter_reports': 'Reports',
      'pawmap_report_pick_hint': 'Move the map to place the red dot on the exact spot, then confirm.',
      'pawmap_report_pick_confirm': 'Report here',
      'pawmap_filter_friends': 'My circle',
      ...
      'unified_filter_cancelled': 'Canceled',
      ...
      'post_input_label': 'Request a service',
      'post_input_hint': 'Write your request here…',
      'post_button': 'Post',
      'post_button_posting': 'Posting...',
      'my_posts_title': 'My requests',
      'home_segment_sitters': 'Pet Sitters',
      'home_segment_walkers': 'Dog Walkers',
      // v426 — owner search header redesign (mockups 50/51).
      'home_around_me': 'Around me',
      'home_my_position': 'My location',
      'home_radius': 'Radius',
      'home_filter_kept_pets': 'Pets accepted',
      'home_filter_walks': 'Walks',
      'home_filter_availability': 'Availability',
      'home_filter_sort': 'Sort',
      'home_sort_distance': 'Distance',
      'home_sort_rating': 'Rating',
      'home_results_sitters': '@count pet-sitters around me',
      'home_results_walkers': '@count dog walkers around me',
      'home_results_found': '@count results found',
      'home_filter_coming_soon': 'Coming soon',
      'home_filter_all': 'All',
      'home_avail_today': 'Today',
      'home_avail_week': 'This week',
      ...
      'notif_title_booking_cancelled': 'Booking canceled',
      ...
      'status_cancelled_label': 'Canceled',
      ...
      'bookings_cancel_success': 'Booking canceled successfully!',
      ...
      'request_cancel_success': 'Request canceled successfully!',
      ...
      'booking_agreement_booking_cancelled': 'Booking Canceled',
      ...
      'booking_agreement_cancelled_at_label': 'Canceled At',
      ...
      'reviews_edit': 'Edit',
      'reviews_delete': 'Delete my review',
      'reviews_updated_success': 'Review updated',
      'reviews_deleted_success': 'Review deleted',
    ...
    'new_publication_button': 'New publication',
      ...
      'post_field_service_location_at_sitter': 'At the sitter’s',
      'post_field_service_location_both': 'Both',
      'post_field_animals': 'Pets',
      'post_about_owner': 'About me',
      'card_request_person': 'Request this person',
      'card_walks_done': 'walks completed',
      'card_request_sitter': 'Send a request',
      'card_request_walk': 'Request a walk',
      'favorite_add_tooltip': 'Add to favorites',
      'favorite_remove_tooltip': 'Remove from favorites',
      'card_available_today': 'Available today',
      'card_available_tomorrow': 'Available tomorrow',
      'card_available_on_request': 'On request',
      'card_response_in': 'Replies in',
      'card_extra_pet': 'Extra pet',
      'card_tariff_day': 'Daily rate',
      'card_tariff_week': 'Weekly rate',
      'card_tariff_month': 'Monthly rate',
      'card_tariff_30min': '30 min rate',
      'card_tariff_1h': '1h rate',
      'card_tariff_2h': '2h rate',
      'card_sub_over_10h': '10h+',
      'card_sub_7_days': '7 days',
      'card_sub_30_days': '30 days',
      'card_per_animal': '/ pet',
      'card_distance_from_you': '@km km from you',
      'card_unavailable': 'Unavailable',
      'card_kept_animals': 'Pets kept',
      'card_walked_animals': 'Pets walked',
      'label_about_me': 'About me',
      'card_role_sitter': 'Pet-sitter',
      'card_role_walker': 'Walker',
      'card_keepings_done': 'sittings completed',
      'post_status_pending': 'Pending',
      'post_character_section': 'Pets’ character',
      'post_photos_count': 'photos',
      'post_photos_count_one': 'photo',
      'pet_type_dog': 'Dog',
      'pet_type_cat': 'Cat',
      'pet_type_small': 'Small pet',
      'pet_type_nac': 'Exotic pet',
      'pet_type_bird': 'Bird',
      ...
      // v442 — provider-facing reservation-annonce detail (walker/sitter).
      'pet_year_unit': 'year',
      'pet_years_unit': 'years',
      'pet_sex_male': 'Male',
      'pet_sex_female': 'Female',
      'post_field_walk_duration': 'Duration',
      'post_field_walk_frequency': 'Frequency',
      'pet_walk_hour_one': 'hour',
      'pet_walk_hours': 'hours',
      'pet_walk_minutes': 'min',
      'post_walk_per_outing': 'per outing',
      'post_walk_per_day': '/ day',
      ...
      'post_apply_cta': 'Apply to this request',
      'post_apply_review_note':
          'The owner will review your profile before accepting your application.',
      'post_gain_estimate_title': 'Your estimated earnings',
      'post_gain_client_pays': 'Client pays',
      'post_gain_commission': 'PawMap commission (10%)',
      'post_gain_you_get': 'You receive',
      'post_gain_variation_note':
          'The final amount may vary depending on the actual booking details.',
      'post_action_save': 'Save',
      'post_boost_active': 'BOOST ACTIVE',
      'post_published_just_now': 'Published just now',
      'post_published_prefix': 'Published',
      'post_time_minutes': 'min ago',
      'post_time_hour': 'hour ago',
      'post_time_hours': 'hours ago',
      'post_time_day': 'day ago',
      'post_time_days': 'days ago',
    ...
    // v531 — tester feedback: share a provider profile (WhatsApp, etc.).
    'share_profile_subject': 'Check out @name on HoPetSit',
    'share_profile_body': 'I recommend @name on HoPetSit, the pet-sitting and dog-walking app @link',
    ...
    'cancel_72h_success': 'Booking canceled and refund initiated.',
    ...
    'create_pet_section_identity': 'Pet identity',
    'create_pet_section_documents': 'Documents & health',
    // v23.1.387 — Paw Premium (bundle) + PawFamily annuel.
    'shop_tab_premium': 'Premium',
    'premium_bundle_ribbon': 'THE MOST COMPLETE',
    'premium_bundle_subtitle': 'The complete pack for pet lovers',
    'premium_bundle_includes': 'INCLUDES',
    'premium_bundle_feat_pawfollow': 'All PawFollow features',
    'premium_bundle_feat_pawspot': 'All PawSpot features',
    'premium_bundle_feat_exclusive': 'Exclusive features',
    'premium_bundle_feat_badge': 'Exclusive Premium badge',
    'premium_bundle_feat_points': 'Double community points',
    'premium_bundle_feat_priority': 'Priority on new features',
    'premium_bundle_plan_monthly': 'Monthly',
    'premium_bundle_plan_yearly': 'Yearly',
    'premium_bundle_savings': 'Save 33% vs the two separate subscriptions',
    'premium_bundle_activated_msg': 'Paw Premium activated!',
    'premium_bundle_active_until': 'Paw Premium active · @days d left',
    'pawfollow_plan_family_yearly': 'PawFamily Yearly',
    'boost_badge': 'Boosted',
    ...
    'pawmap_premium_on_title': 'PawPremium active',
    'pawmap_premium_on_msg': 'Your Paw Premium subscription is active. Manage it in the shop.',
    ...
    'pawfollow_section_solo_sub': 'Locate and track your companion in real time',
    'pawfollow_section_family_sub': 'You + 5 invited members (6 in total): share tracking as a family',
    ...
    'walker_rate_hint_15': 'e.g. 15',
      ...
      'payment_made_banner_title': 'Payment sent!',
      'chat_with_owner_button': 'Chat with the owner',
      'chat_with_sitter_button': 'Chat with the pet-sitter',
      'chat_with_walker_button': 'Chat with the dog walker',
    ...
    'referrals_subtitle': 'Invite your friends, get -10% off PawFollow/PawFamily',
    ...
    'service_sit_home': "At the sitter's home",
    'service_sit_owner': "At the owner's home",
    'service_daycare': 'Day care',
    'service_meds': 'Medication',
    'service_vet_transport': 'Vet transport',
    ...
    'premium_feature_friends_tracking': 'Friends & family live on the map — free; PawFollow extends it to 2 h and in the background',
    ...
    // v23.1 part 244 — walk tracking screen.
    'walk_active_status': 'Walk in progress · @count position(s) sent',
    'walk_ready_status': 'Ready to start the walk',
    'walk_position_hint': 'Position sent automatically every 10m+ moved',
    'walk_start_btn': 'Start walk',
    'walk_stop_btn': 'End walk',
    'live_track_perm_denied': 'Location permission denied.',
    // v23.1 part 244 — friends screen dialog + empty states.
    'friends_dialog_search_hint': 'Search by email or name (min. 2 characters)',
    'friends_dialog_search_placeholder': 'friend@example.com or Daniel',
    'friends_dialog_empty_state': 'Type an email or a name',
    'common_no_results': 'No results',
    'friends_empty_title': 'No friends yet',
    'friends_empty_subtitle': 'Add friends to see them live on the PawMap.',
    // v23.1 part 244c — chat list FAB.
    ...
    'top_walker_need_walks': '@walks more walks · rating ✓',
    ...
    'service_card_provider_complete_btn': 'I returned the pet',
    ...
    'service_card_owner_confirm_desc': 'The provider says they returned your pet. Confirm everything went well to release the payment.',
    'service_card_confirm_btn': 'All good',
    'service_card_dispute_btn': 'Report a problem',
    ...
    'service_started_snack_title': 'Service started',
    'service_started_snack_msg': 'The owner has been notified that you picked up the pet.',
    'service_completed_snack_title': 'Service completed',
    'service_completed_snack_msg': 'The owner must confirm to release your payment (auto within 48h).',
    'service_confirmed_snack_title': 'Thank you!',
    'service_confirmed_snack_msg': 'Service confirmed. Payment released to the provider.',
    'service_disputed_snack_title': 'Issue reported',
    'service_disputed_snack_msg': 'Payment is on hold. Contact the provider via chat to resolve.',
  ...
  'common_next': 'Next',
  'pet_section_about': 'About',
  'pet_section_health': 'Health',
  'pet_section_habits': 'Habits',
  // v440 — pet profile rebuild.
  'pet_presentation': 'Presentation',
  ...
  'pet_color': 'Color',
  'pet_sex': 'Sex',
  'pet_no_data': 'Not provided',
  'pet_trait_dominant': 'Dominant',
  'pet_compat_nac': 'With exotic pets',
  'pet_vax_partial': 'Partial',
  'pet_vax_not_provided': 'Not provided',
  'pet_sterilized': 'Neutered',
  'pet_microchipped': 'Microchip',
  'pet_food_restrictions': 'Dietary restrictions',
  'pet_documents': 'Documents',
  'pet_doc_health_book': 'Health record',
      'pet_documents_pick_hint': 'Check the documents you have',
      'pet_doc_none': 'No document provided',
      'pet_doc_upload': 'Add a document',
      'pet_doc_eu_passport': 'EU passport',
      'pet_doc_vaccination_card': 'Vaccination card',
      'pet_doc_sterilization_cert': 'Sterilization certificate',
      'pet_doc_identification': 'Identification',
      'pet_doc_insurance_doc': 'Insurance certificate',
  'pet_doc_passport': 'European passport',
  'pet_doc_add_hint': 'Add your documents from the pet gallery.',
  'pet_sleep': 'Sleep',
      'pet_habits_quick': 'Habits (quick pick)',
      'pet_habit_likes_sleeping': 'Likes sleeping',
      'pet_habit_calm': 'Calm',
      'pet_habit_nervous': 'Nervous',
      'pet_habit_dislikes_cats': 'Dislikes cats',
      'pet_habit_dislikes_dogs': 'Dislikes dogs',
      'pet_habit_playful': 'Playful',
      'pet_habit_sociable': 'Sociable',
      'pet_habit_barks': 'Barks',
      'pet_habit_greedy': 'Greedy',
      'pet_habit_fearful': 'Fearful',
      'pet_habit_clean': 'Clean',
      'pet_habit_energetic': 'Energetic',
      'pet_habit_cuddly': 'Cuddly',
      'pet_habit_independent': 'Independent',
  'pet_sleep_indoor': 'Indoors',
  'pet_sleep_outdoor': 'Outdoors',
  'pet_sleep_crate': 'Crate',
  'pet_housetrained': 'House-trained',
  'pet_housetrained_yes': 'Yes',
  'pet_housetrained_learning': 'Learning',
  'pet_leash': 'Walking',
  'pet_leash_off': 'Off-leash',
  'pet_leash_on': 'On-leash',
  'pet_leash_recall': 'Reliable recall',
  'pet_fears': 'Afraid of',
  'pet_yes': 'Yes',
  'pet_no': 'No',
  'pet_gallery_limit_photos': 'Maximum of 20 photos reached.',
  'pet_gallery_limit_videos': 'Maximum of 5 videos reached.',
  'pet_tab_about': 'About',
  'pet_profile_title': '@name’s profile',
  'pet_change_photo': 'Change photo',
  'pet_up_to_date': 'Up to date',
  'pet_no_treatment': 'No current treatment',
  'pet_gallery_title': 'Photo gallery',
  'pet_add_photos': 'Add photos',
  'pet_tab_health': 'Health',
  'pet_tab_habits': 'Habits',
  'pet_tab_gallery': 'Gallery',
  'pet_bio': 'Bio',
  'pet_physical': 'Physical',
  ...
  'pet_set_as_main': 'Set as main',
  'pet_delete_photo': 'Delete photo',
  'pet_videos_title': 'Videos',
  'pet_main_photo': 'Main photo',
  'pet_age_unit': 'yrs',
  'pet_gender': 'Sex',
  'pet_gender_male': 'Male',
  'pet_gender_female': 'Female',
  'pet_character_traits': 'Character',
  'pet_trait_energetic': 'Energetic',
  'pet_trait_calm': 'Calm',
  'pet_trait_playful': 'Playful',
  'pet_trait_social': 'Social',
  'pet_trait_affectionate': 'Affectionate',
  'pet_trait_protective': 'Protective',
  'pet_trait_smart': 'Smart',
  'pet_trait_independent': 'Independent',
  'pet_trait_shy': 'Shy',
  'pet_trait_curious': 'Curious',
  'pet_trait_gentle': 'Gentle',
  'pet_trait_obedient': 'Obedient',
  'pet_compatibilities': 'Compatibility',
  'pet_compat_dogs': 'With dogs',
  'pet_compat_cats': 'With cats',
  'pet_compat_children': 'With children',
  'pet_compat_yes': 'Compatible',
  'pet_compat_supervised': 'Supervised',
  'pet_compat_no': 'No',
  'pet_history': 'History',
  'pet_particularities': 'Particularities',
  'pet_particularity_add_hint': 'Add a particularity',
  'pet_notes': 'Notes',
  'pet_vaccination_status': 'Vaccines',
  'pet_vax_up_to_date': 'Up to date',
  'pet_vax_late': 'Late',
  'pet_vax_unknown': 'Unknown',
  'pet_deworming': 'Deworming',
  'pet_deworming_last_date': 'Last deworming',
  'pet_deworming_frequency': 'Frequency',
  'pet_current_treatments': 'Current treatments',
  'pet_treatment_ongoing': 'Ongoing treatment?',
  'pet_blood_group': 'Blood group',
  'pet_health_insurance': 'Health insurance',
  'pet_insurance_name': 'Insurance name',
  'pet_insurance_number': 'Number',
  'pet_energy_level': 'Energy level',
  'pet_energy_low': 'Low',
  'pet_energy_medium': 'Medium',
  'pet_energy_high': 'High',
  'pet_preferred_activity': 'Favorite activity',
  'pet_education': 'Training',
  'pet_alone_tolerance': 'Time alone',
  'pet_barking': 'Barking',
  'pet_likes': 'Likes',
  'pet_dislikes': 'Dislikes',
  'pet_transport': 'Transport',
  'pet_brushing': 'Brushing',
  'pet_food': 'Food',
  'pet_allowed_treats': 'Allowed treats',
  'pet_favorite_objects': 'Favorite toys',
  'pet_favorite_places': 'Favorite places',
  'pet_remarks': 'Remarks',
  'pet_animal_dog': 'Dogs',
  'pet_animal_cat': 'Cats',
  'pet_animal_small': 'Small pets',
      'signup_new_profile': 'New profile',
      'signup_review_services': 'Services offered',
      'signup_review_rates': 'My rates',
      'signup_per_extra_animal': 'per extra animal',
      'signup_response_15': 'Reply: 15 min',
      'signup_available_today': 'Available today',
  'pet_animal_nac': 'Exotic',
  'pet_animal_rodent': 'Rodents',
  'pet_animal_bird': 'Birds',
  'pet_animal_reptile': 'Reptiles',
  'profile_tab_profile': 'Profile',
  'profile_tab_preferences': 'Preferences',
  'profile_tab_security': 'Security',
  'profile_prefs_title': 'My preferences',
  'profile_pref_notifications': 'Receive notifications',
  'profile_pref_notifications_sub': 'For new profiles',
  'profile_pref_quick_replies': 'Quick replies',
  'profile_pref_quick_replies_sub': 'From providers',
  'profile_pref_photos': 'Send photos / videos',
  'profile_pref_photos_sub': 'During services',
  'profile_pref_pawmap_insurance': 'PawMap insurance',
  'profile_pref_pawmap_insurance_sub': 'Automatically included',
  'profile_pref_flexible_cancellation': 'Flexible cancellation',
  'profile_pref_flexible_cancellation_sub': 'Subject to conditions',
  'profile_pref_language': 'Preferred language',
  'profile_pref_privacy': 'Privacy',
  'profile_pref_hide_map': 'Hide my profile on the map',
  'profile_pref_hide_map_sub': 'You no longer appear on the public PawMap. Your friends can still see you. You stay visible in search.',
  'profile_2fa': 'Two-factor authentication',
  'profile_2fa_sub': 'Secure your account with a code',
  'profile_2fa_enabled': '2FA enabled',
  'profile_2fa_disabled': '2FA disabled',
  'profile_verifications': 'Verifications',
  'profile_phone': 'Phone',
  'profile_email': 'Email',
  'profile_verified': 'Verified',
  'profile_not_verified': 'Not verified',
  'signup_wizard_title_owner': 'Sign up as an owner',
  'signup_wizard_title_sitter': 'Sign up as a pet-sitter',
  'signup_wizard_title_walker': 'Sign up as a walker',
  'signup_wizard_sub_owner': 'Join our community of pet owners',
  ...
  'signup_pw_min': 'At least 8 characters',
  'signup_pw_upper': '1 uppercase',
  'signup_pw_digit': '1 number',
  'signup_pw_lower': '1 lowercase',
  'signup_pw_mismatch': 'Passwords do not match',
  'signup_step_pets': 'My pets',
  'signup_pets_hint': 'Add your pets so sitters and walkers can get to know them.',
  'signup_pets_after_verification': 'You can add your pets right after verifying your email.',
  'signup_step_search': 'What you’re looking for',
  'signup_search_hint': 'Select the services you need.',
  'signup_service_walk': 'Walk',
  'signup_service_walk_sub': 'Outings and walks',
  'signup_service_daycare': 'Day care',
  'signup_service_daycare_sub': 'Daytime care (+10h)',
  'signup_service_boarding': 'Boarding',
  'signup_service_boarding_sub': 'Care while you’re away',
  'signup_service_visit': 'Home visit',
  'signup_service_visit_sub': 'Visits and home care',
  'signup_search_radius': 'Default search radius',
  'signup_step_prefs': 'Your preferences',
  'signup_pref_language': 'Preferred language',
  'signup_step_location': 'Location',
  'signup_location_auto': 'Auto (my location)',
  'signup_field_city': 'City',
  'signup_field_radius': 'Service radius',
  'signup_animals_walked': 'Animals walked',
  'walker_service_label': 'Service type',
  'walker_svc_individual': 'Individual walk',
  'walker_svc_group': 'Group walk',
  'walker_svc_long': 'Long walk / Hike',
  'walker_svc_visit': 'Home visit',
  'signup_animals_accepted': 'Animals accepted',
  'signup_availability': 'Availability',
  'signup_durations': 'Durations offered',
  'signup_services_offered': 'Services offered',
  'signup_sitsvc_at_mine': 'Care at my home',
  'signup_sitsvc_at_owner': 'Care at owner’s home',
  'signup_sitsvc_daycare': 'Day care (+10h)',
  'signup_sitsvc_meds': 'Medication administration',
  'signup_sitsvc_vet_transport': 'Vet transport',
  'signup_step_about': 'About you',
  'signup_about_you': 'Tell us about yourself',
      'signup_about_hint_owner': 'Tell us about you and your pets (shown on your listing)',
  'signup_about_hint': 'Describe your experience with animals…',
  'signup_experience': 'Experience',
  'signup_exp_passionate': 'Animal lover',
  'signup_exp_owner': 'Pet owner',
  'signup_exp_ex_sitter': 'Professional pet-sitter',
  'signup_exp_training': 'Animal training',
  'signup_exp_educator': 'Animal educator',
  'signup_exp_vet_aux': 'Veterinary assistant',
  'signup_exp_shelter': 'Shelter volunteer',
  'signup_exp_training_dog': 'Dog training',
  'signup_exp_ex_pro_walker': 'Professional walker',
  'signup_exp_educator_dog': 'Dog educator',
  'signup_step_rates': 'My rates',
  'signup_currency': 'Currency',
  'signup_rate_30min': 'Rate for 30 min',
  'signup_rate_1h': 'Rate for 1 hour',
  'signup_rate_2h': 'Rate for 2 hours',
  'signup_rate_day': 'Day rate (+10h)',
  'signup_rate_week': 'Weekly rate (7 days)',
  'signup_rate_month': 'Monthly rate (30 days)',
  'signup_rate_extra_animal': 'Extra animal',
  'signup_rate_response_time': 'Response time',
  'signup_rate_extra_hint': 'The supplement applies to each added animal.',
  'signup_step_review_account': 'Account preview',
  'signup_step_review_profile': 'Profile preview',
  'signup_review_editable_hint': 'You can edit this information anytime in your profile.',
  'signup_accept_terms': 'I accept the terms of use and the privacy policy.',
  'signup_create_account': 'Create my account',
  'signup_create_profile': 'Create my profile',
  'day_mon': 'Monday',
  'day_tue': 'Tuesday',
  'day_wed': 'Wednesday',
  'day_thu': 'Thursday',
  ...
  'publish_character_preview_label': 'Preview — shown on your listing',
  'publish_request_select_pet_required': 'Select at least one pet.',
  'publish_character_no_pet_selected': 'Select a pet to see its character.',
  'publish_character_preview_empty': 'No character traits on the selected pets.',
  ...
  // Promo code — entering/validating a code issued by the admin (Promotions).
  'promo_screen_title': 'Promo code',
  'promo_profile_tile_subtitle': 'Enter a code to unlock an offer',
  'promo_screen_heading': 'Have a promo code?',
  'promo_screen_subtitle': 'Enter your code to enjoy a free subscription or a discount on your purchases.',
  'promo_field_label': 'Promo code',
  'promo_field_hint': 'E.G. LAUNCH-ABC123',
  'promo_apply_button': 'Apply code',
  'promo_success_title': 'Code applied!',
  'promo_success_generic': 'Your code has been applied.',
  'promo_success_subscription': 'Your @plan subscription is now active.',
  'promo_success_discount': 'You get @percent% off.',
  'promo_success_discount_hint': 'The discount will apply on your next purchase in the shop.',
  'promo_error_empty': 'Enter a promo code.',
  'promo_error_invalid': 'Invalid or expired code.',
  'promo_error_already_used': 'You have already used this code.',
  'promo_error_network': 'No connection. Please try again.',
  'promo_error_generic': 'Could not apply the code.',
  ...
  'pawmap_member_approx': 'Approximate location (within {km} km)',
  'pawmap_member_book': 'Book',
  'pawmap_member_price_from': 'from',
  'pawmap_members_around': '@count members around you',
  'pawmap_dock_sos': 'Pet SOS',
  'pawmap_btn_directions': 'Directions',
  'pawmap_btn_circle_chat': 'Circle chat',
  'pawmap_btn_spot_photo': 'Spot photo',
  'pawmap_dock_share_map': 'Share map',
  'pawmap_dock_layers': 'Layers',
  'pawmap_dock_night': 'Night mode',
  'pawmap_dock_history': 'History',
  'pawmap_layer_members': 'Members',
  'pawmap_share_map_text': 'Look at this spot on the HoPetSit PawMap:',
  'pawmap_sos_title': 'Send a pet SOS?',
  'pawmap_sos_body': 'A priority alert will be placed at your location and EVERY HoPetSit member within 10 km will get a notification. Only use this for a genuinely lost pet.',
  'pawmap_sos_send': 'Send SOS',
  'pawmap_sos_sent_title': 'SOS sent',
  'pawmap_sos_sent_msg': '@count members around you were notified.',
  'pawmap_sos_cooldown': 'You already sent an SOS less than an hour ago.',
  'pawmap_sos_failed': 'Could not send the SOS. Please try again.',
  'friends_share_qr': 'QR code',
  'friends_share_email': 'Email',
  'friends_share_qr_title': 'Have them scan this QR code',
  'friends_share_qr_hint': 'Whoever scans it lands straight on your friend request.',
  ...
  'update_available_body': 'A newer version of HoPetSit is available with improvements and fixes. Update to enjoy everything.',
  'update_required_title': 'Update required',
  'update_required_body': 'This version of HoPetSit is no longer supported. Update the app to continue.',
  'update_btn_store': 'Update now',
  'update_btn_later': 'Later',
  'pawmap_btn_around': 'Around me',
  'pawmap_around_title': 'Around me',
  'pawmap_around_subtitle': 'Pick a radius, a mode and a category',
  'pawmap_around_km': 'within {km} km',
