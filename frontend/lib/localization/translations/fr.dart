...
const Map<String, String> frFRTranslations = <String, String>{
      ...
      'unit_week': 'semaine',
      'unit_month': 'mois',
      'signup_city_detected': 'Ta ville',
      'signup_change_city': 'Modifier',
      'guest_near_title': 'Gardiens près de chez vous',
      'guest_latest': 'Les derniers inscrits',
      'guest_filter_all': 'Tous',
      'guest_see_all': 'Voir tout',
      'guest_about': 'À propos',
      'guest_services': 'Services et tarifs',
      'login_or_email': 'ou avec votre e-mail',
      'login_remember': 'Se souvenir de moi',
      'login_resume': 'Reprendre',
      'login_last_session': 'dernière session',
      'login_new': 'Nouveau ?',
      'login_create': 'Créer un compte',
      'guest_hero_title_1': 'Le meilleur pour votre',
      'guest_hero_title_2': 'compagnon',
      'guest_already': 'Déjà un compte ?',
      'guest_role_guest_sub': 'J\'explore sans créer de compte.',
      'guest_role_guest': 'Invité',
      'guest_badge_trust': 'Communauté de confiance',
      'guest_hero_title': 'Le meilleur pour votre compagnon',
      'guest_hero_sub': 'Trouvez un pet sitter ou un promeneur de confiance près de chez vous.',
      'guest_feat_verified': 'Profils vérifiés',
      'guest_feat_verified_sub': 'Contrôles d\'identité',
      'guest_feat_gps': 'GPS en temps réel',
      'guest_feat_gps_sub': 'Suivez chaque balade',
      'guest_feat_pay': 'Paiement sécurisé',
      'guest_feat_pay_sub': '100 % protégé',
      'guest_feat_chat': 'Messagerie intégrée',
      'guest_feat_chat_sub': 'Échangez facilement',
      'guest_iwant': 'Je veux…',
      'guest_role_owner_sub': 'Je cherche un gardien de confiance.',
      'guest_role_sitter_sub': 'Je garde des animaux en sécurité.',
      'guest_role_walker_sub': 'Je promène des chiens près de chez moi.',
      'guest_discover_btn': 'Découvrir les gardiens près de chez vous',
      'guest_create_sub': 'C\'est rapide, gratuit et sécurisé',
      'guest_continue_apple': 'Continuer avec Apple',
      'guest_continue_google': 'Continuer avec Google',
      'guest_signup_email': 'S\'inscrire avec mon e-mail',
      'guest_terms_note': 'En créant un compte, vous acceptez nos Conditions d\'utilisation et notre Politique de confidentialité.',
      'guest_tab_map': 'Carte',
      'guest_tab_list': 'Liste',
      'guest_tab_requests': 'Demandes',
      'guest_verified': 'Vérifié',
      'guest_from_price': 'Dès @price',
      'guest_respond': 'Répondre',
      'guest_no_requests': 'Aucune demande pour le moment — revenez bientôt !',
      ...
      'guest_wall_subtitle': 'Gratuit, moins d\'une minute. Profils vérifiés, paiements sécurisés.',
      'guest_wall_signup': 'S\'inscrire',
      'guest_wall_login': 'J\'ai déjà un compte',
      'pawspot_share': 'Partager ce lieu',
      'pawspot_share_message': 'J\'ai trouve @name sur HoPetSit, un super endroit pour nos animaux :',
      'pawspot_share_copied': 'Lien copie',
      'handover_owner_code_title': 'Code de remise',
      'handover_owner_code_desc': 'Donne-le au prestataire quand tu lui confies ton animal.',
      'handover_owner_code_copied': 'Code copie',
      'handover_pickup_title': 'Je récupère l\'animal',
      ...
      'handover_confirm_pickup': 'Confirmer la récupération',
      ...
      'common_accepted': 'Acceptée',
      'common_refused': 'Refusée',
      'friend_request_accepted_msg': 'Vous êtes maintenant amis.',
      ...
      'pawfollow_feature_live_toggle': 'Partage en direct longue durée : 2 h par session, même app fermée, avec l’historique de tes balades',
      ...
      'pawspot_points_popular': '+25 : spot très populaire (50)',
      ...
      'route_steps_btn': 'Étapes',
      'route_steps_title': 'Itinéraire pas à pas',
      ...
      'poi_hours_label': 'Horaires',
      'poi_call': 'Appeler',
      'send_request_walk_datetime_label': 'Date et heure de la promenade',
      'send_request_end_auto_hint': 'L\'heure de fin sera calculée depuis la durée que tu choisis plus bas.',
      'send_request_end_auto_value': 'Fin automatique : {time} (durée {min} min)',
      'sitter_app_summary_bookings': 'Réservations',
      'sitter_app_empty_all': 'Aucune candidature ni réservation',
      'sitter_app_empty_filter': 'Aucun résultat pour ce filtre',
      'friends_deleted_user': 'Utilisateur supprimé',
      'friends_accepted_title': 'Accepté',
      'friends_accepted_msg': 'Vous êtes maintenant amis.',
      'deeplink_expired_msg': 'Lien expiré. Réessaye depuis le site.',
      'payment_airwallex_title': 'Le paiement passe désormais par Airwallex',
      'payment_airwallex_hint': 'Reviens à l\'écran précédent et relance ton achat : un nouveau formulaire de paiement va s\'ouvrir.',
      'payment_secure_title': 'Paiement sécurisé',
      'payment_airwallex_pci': 'Le paiement est traité par Airwallex (PCI-DSS niveau 1). Tes données de carte ne transitent jamais par HoPetSit.',
      'add_card_airwallex_hint': 'Avec Airwallex, ta carte est enregistrée automatiquement lors de ton premier paiement. Plus besoin de l\'ajouter à l\'avance.',
      'auth_choose_account_type_msg': 'Choisis ton type de compte (propriétaire, gardien ou promeneur).',
      'payout_setup_title': 'Configuration de paiement',
      'payout_setup_msg': 'Renseigne ton IBAN dans Profil → Compte bancaire pour recevoir tes paiements.',
      'pet_emergency_consent_text': 'J\'autorise le petsitter à contacter le vétérinaire d\'urgence et à engager les soins nécessaires en cas de danger vital pour mon animal, avec prise en charge financière à ma charge. Je reste joignable à tout moment.',
      'pawmap_request_default_title': 'Demande de garde',
      'price_days_one': '1 jour',
      'price_days_n': '{n} jours',
      'price_month_one': '1 mois',
      'price_week_one': '1 semaine',
      'pawmap_quick_family_sub': 'Ajouter',
      'pawmap_quick_people_live': 'En direct',
      'pawmap_quick_people_live_sub': 'Position partagée',
      ...
      'friends_add_search_help': 'Tape au moins 2 caractères pour chercher.',
      'friends_add_search_empty': 'Cherche un ami par email ou nom.',
      'friends_add_no_results': 'Aucun résultat. Invite-le via le lien ci-dessus.',
      ...
      'friends_messages_empty_msg': 'Tes conversations avec amis et famille apparaîtront ici une fois démarrées.',
      // v23.1 part 226 — Daniel : "message marche pa page blanche".
      'friends_messages_empty_cta': 'Va dans l\'onglet «Amis» et appuie sur à côté d\'un ami pour démarrer une conversation.',
      ...
      'alerts_filter_period_title': 'Période',
      'alerts_search_title': 'Rechercher',
      'alerts_search_hint': 'Animal, lieu, type...',
      'alerts_period_24h': '24 dernières heures',
      'alerts_period_48h': '48 dernières heures',
      ...
      'alerts_no_gps_msg': 'Active la localisation pour signaler une alerte. Sans GPS valide, ton signalement ne pourrait pas être vu par les autres.',
      ...
      'alerts_diagnose_failed': 'Impossible de récupérer le diagnostic.',
      ...
      'report_cat_aggressive_dog': 'Chien méchant',
      ...
      'report_section_premium_hint': 'Nécessite un abo PawFollow / PawFamily.',
      ...
      'tracking_sheet_contact_via_chat': 'Pour le contacter, utilisez la conversation. Ses coordonnées restent privées.',
      ...
      'pawfollow_bullet_control': 'Vous gardez le contrôle à tout moment.',
      ...
      'Application accepted successfully': 'Candidature acceptée avec succès',
      'Application rejected successfully': 'Candidature rejetée avec succès',
      'Blocked users saved successfully': 'Utilisateurs bloqués enregistrés avec succès',
      'Card saved successfully!': 'Carte enregistrée avec succès !',
      'Could not detect your location. Please enable location services.': 'Impossible de détecter votre position. Veuillez activer les services de localisation.',
      'Could not load nearby sitters. Please try again.': 'Impossible de charger les pet sitters à proximité. Veuillez réessayer.',
      'Email verified successfully!': 'E-mail vérifié avec succès !',
      'Failed to add task. Please try again.': 'Impossible d\'ajouter la tâche. Veuillez réessayer.',
      ...
      'Failed to fetch tasks.': 'Impossible de récupérer les tâches.',
      'Failed to get your location. Please try again.': 'Impossible d\'obtenir votre position. Veuillez réessayer.',
      'Failed to load booking details. Using default pricing.': 'Impossible de charger les détails de réservation. Tarification par défaut utilisée.',
      ...
      'Failed to pick image. Please try again.': 'Impossible de sélectionner l\'image. Veuillez réessayer.',
      'Failed to pick passport image. Please try again.': 'Impossible de sélectionner l\'image du passeport. Veuillez réessayer.',
      'Failed to pick pet pictures or videos. Please try again.': 'Impossible de sélectionner les photos ou vidéos de l\'animal. Veuillez réessayer.',
      'Failed to pick pet profile image. Please try again.': 'Impossible de sélectionner l\'image de profil de l\'animal. Veuillez réessayer.',
      'Failed to save card. Please try again.': 'Impossible d\'enregistrer la carte. Veuillez réessayer.',
      'Failed to start conversation. Please try again.': 'Impossible de démarrer la conversation. Veuillez réessayer.',
      'Failed to submit review. Please try again.': 'Impossible d\'envoyer l\'avis. Veuillez réessayer.',
      'Failed to switch role. Please try again.': 'Impossible de changer de rôle. Veuillez réessayer.',
      'Height is required.': 'La taille est requise.',
      'Height must be greater than 0.': 'La taille doit être supérieure à 0.',
      'Hourly rate must be greater than 0.': 'Le tarif horaire doit être supérieur à 0.',
      ...
      'Pet profile created but media upload failed. You can add media later.': 'Profil de l\'animal créé, mais le téléchargement des médias a échoué. Vous pouvez ajouter des médias plus tard.',
      ...
      'Please enter the complete verification code': 'Veuillez saisir le code de vérification complet',
      ...
      'Please verify your email to continue.': 'Veuillez vérifier votre e-mail pour continuer.',
      ...
      'Unknown user role. Please try again.': 'Rôle utilisateur inconnu. Veuillez réessayer.',
      'Verification code has been resent to your email': 'Le code de vérification a été renvoyé à votre e-mail',
      ...
      'friend_diagnose_failed': 'Impossible de récupérer le diagnostic.',
      ...
      'kyc_unavailable_title': 'Vérification temporairement indisponible',
      'kyc_unavailable_msg': 'La vérification d\'identité est désactivée pour le moment. Ton paiement est conservé, on activera bientôt.',
      'kyc_payment_required_title': 'Paiement requis',
      'kyc_payment_required_msg': 'Tu dois payer les 3 EUR de frais de vérification avant de lancer le scan ID + selfie.',
      'kyc_already_verified_title': 'Déjà vérifié',
      'kyc_already_verified_msg': 'Ton identité est déjà vérifiée — le badge "Vérifié" est actif sur ton profil.',
      'kyc_only_provider_msg': 'La vérification Didit est réservée aux pet-sitters et promeneurs.',
      ...
      'pawfollow_request_provider_wants_to_share': 'Le promeneur / pet-sitter veut partager sa position avec toi',
      ...
      'follow_button_walker': 'Suivre le promeneur',
      'follow_button_sitter': 'Suivre le pet-sitter',
      ...
      'follow_pawfollow_required_msg': 'Active PawFollow pour suivre ton promeneur ou pet-sitter en direct.',
      ...
      'live_tracking_request_body': 'Ton promeneur / pet-sitter t\'invite à suivre sa position en direct.',
      ...
      'onboarding_feature_trusted_desc': 'Pet-sitters de confiance près de toi.',
      ...
      'coin_shop_pawspot_summary_fallback': 'PawSpot utilise ton adresse perso. Choisis un emplacement spécifique pour mieux apparaître sur la carte.',
      ...
      'signup_error_email_taken': 'Un compte existe déjà avec cet email. Connecte-toi plutôt.',
      'signup_error_too_many': 'Trop de tentatives. Attends une minute et réessaie.',
      'common_error_no_network': 'Pas de connexion internet. Vérifie ton réseau et réessaie.',
      'signup_error_city_required': 'Choisis ta ville pour voir ce qui se passe autour de toi.',
      'signup_error_service_required': 'Sélectionne au moins un service.',
      'signup_error_animals_required': 'Sélectionne au moins un animal que tu acceptes.',
      'signup_error_rate_required': 'Indique au moins un tarif pour que les propriétaires puissent te réserver.',
      ...
      'service_selection_required': 'Sélection requise',
      ...
      'shop_promo_discount_note': 'code promo -@percent%',
      ...
      'payout_add_paypal_email_subtitle': 'Définissez l\'email où vous souhaitez recevoir les paiements. Vous pourrez le modifier plus tard depuis le statut des paiements.',
      'payout_status_saved': 'Enregistré',
      'payout_status_not_set': 'Non défini',
      ...
      'payout_verification_title': 'Statut de vérification',
      'payout_status_title': 'Statut des paiements',
      'payout_verification_step_bank': 'Vérification du compte bancaire',
      'payout_verification_step_business': 'Informations de l\'entreprise',
      'payout_next_payout_label': 'Prochain paiement',
      'payout_schedule_label': 'Fréquence des paiements',
      'payout_schedule_daily': 'Quotidien',
      'payout_minimum_amount_label': 'Montant minimum',
      'payout_status_verified': 'Vérifié',
      'payout_status_pending': 'En attente',
      'payout_status_rejected': 'Rejeté',
      'payout_status_not_started': 'Non commence',
      'payout_status_active': 'Actif',
      'payout_status_restricted': 'Restreint',
      'payout_verification_message_verified': 'Votre compte a été vérifié. Vous pouvez maintenant recevoir des paiements.',
      'payout_verification_message_pending': 'Votre vérification est en cours d\'examen. Cela prend généralement 1 à 2 jours ouvrables.',
      'payout_verification_message_rejected': 'Votre vérification a été rejetée. Veuillez mettre à jour vos informations et réessayer.',
      'payout_verification_message_not_started': 'Veuillez terminer la vérification pour commencer à recevoir des paiements.',
      'payout_message_active': 'Vos paiements sont actifs. Les gains seront transférés quotidiennement sur votre compte bancaire.',
      ...
      'friends_request_wants': 'souhaite être ami avec toi',
      'shop_pb_plus_body': 'Ton profil passe en tête du fil pendant la durée choisie, avec le badge « Boosté » : tu es vu en premier, tu reçois plus de demandes.',
      'shop_pb_plus_title': 'Avec PawBoost',
      'shop_pb_free_body': 'Ton profil apparaît dans les recherches des propriétaires de ta ville, classé par distance et par avis.',
      'shop_pb_free_title': 'Gratuit pour tous',
      'shop_pp_plus_body': 'Tout PawFollow et PawSpot réunis, tous les signalements premium, notifications instantanées, chat illimité, couronne sur ton profil. Moins cher que les deux séparés.',
      'shop_pp_plus_title': 'Avec PawPremium',
      'shop_pp_free_body': 'Signalements gratuits (animal perdu, trouvé, point d\'eau, véto ouvert) et alertes en temps réel autour de toi.',
      'shop_pp_free_title': 'Gratuit pour tous',
      'shop_ps_plus_body': 'Tags illimités, spots populaires, badges et récompenses, itinéraires inclus, 20 signalements premium.',
      'shop_ps_plus_title': 'Avec PawSpot',
      'shop_ps_free_body': 'Voir tous les PawSpots et lieux de la communauté, taguer tes 3 premiers spots, gagner des PawPoints.',
      'shop_ps_free_title': 'Gratuit pour tous',
      'pawspot_free_tags_note': '3 premiers tags gratuits pour tout le monde — illimités avec l\'abonnement',
      'pawfollow_feature_history': 'Historique de tes balades et trajets',
      'shop_pf_plus_body': '2 h par session, même app fermée · itinéraires · historique de balade · famille jusqu\'à 5 personnes.',
      'shop_pf_plus_title': 'Avec PawFollow',
      'shop_pf_free_body': 'Partage ta position en direct avec tes amis (30 min par session, app ouverte) et suis ton promeneur ou gardien pendant la garde.',
      'shop_pf_free_title': 'Gratuit pour tous',
      'pawmap_live_free_cap_msg': 'Partage arrêté après 30 min (session gratuite). Avec PawFollow : 2 h, même app fermée, itinéraires et historique.',
      'pawspot_photo_uploading': 'Envoi de la photo…',
      'pawmap_pick_title_spot': 'Placer un Paw Spot',
      'pawmap_pick_title_report': 'Placer un signalement',
      'pawmap_pick_title_route': 'Itinéraire vers ce point',
      'pawmap_pick_locating': 'Recherche de l’adresse…',
      'pawmap_route_pick_hint': 'Déplace la carte sur ta destination, puis valide',
      'pawmap_search_recent': 'Recherches récentes',
      'pawmap_refresh_done': 'Carte à jour',
      ...
      'mapboost_info_visibility': 'Ton PawSpot est visible par les propriétaires qui regardent la map à cet endroit. Passe en mode Propriétaire et ouvre la map pour le vérifier toi-même.',
      ...
      'post_input_label': 'Demander un service',
      'post_input_hint': 'Écris ta demande ici…',
      'post_button': 'Publier',
      'post_button_posting': 'Publication en cours...',
      'my_posts_title': 'Mes annonces',
      ...
      'my_posts_delete_message': 'Voulez-vous vraiment supprimer cette publication ? Cette action est irréversible.',
      'my_posts_delete_success': 'Publication supprimée avec succès.',
      'my_posts_delete_failed': 'Échec de la suppression de la publication. Veuillez réessayer.',
      ...
      'notifications_application_not_found': 'Cette demande n\'est plus disponible ou n\'a pas pu être chargée.',
      ...
      'publish_request_venue_required': 'Choisis chez qui aura lieu la garde (chez toi ou chez le pet-sitter).',
      ...
      'publish_request_service_pet_sitting_desc': 'Plusieurs jours, chez toi ou chez le pet-sitter',
      ...
      'snackbar_choose_service_controller_001': 'Choisis des services valides pour ton type de compte.',
      'snackbar_choose_service_controller_002': 'Tes services ont bien été mis à jour !',
      'snackbar_choose_service_controller_003': 'Tes services ont bien été sélectionnés !',
      'snackbar_choose_service_controller_004': 'Impossible de mettre à jour les services. Réessaie.',
      'snackbar_choose_service_controller_005': 'Choisis au moins un service pour continuer.',
      'snackbar_choose_service_controller_006': 'Choisis un service valide pour continuer.',
      'snackbar_choose_service_controller_007': 'Choisis au moins un service.',
      ...
      'snackbar_sitter_paypal_payout_controller_003': 'Échec de la mise à jour de l\'e-mail PayPal de paiement. Veuillez réessayer.',
      ...
      'snackbar_text_application_accepted_successfully': 'Candidature acceptée avec succès',
      'snackbar_text_application_rejected_successfully': 'Candidature rejetée avec succès',
      'snackbar_text_blocked_users_saved_successfully': 'Utilisateurs bloqués enregistrés avec succès',
      'snackbar_text_card_saved_successfully': 'Carte enregistrée avec succès !',
      'snackbar_text_could_not_detect_your_location_please_enable_location_servic': 'Impossible de détecter votre position. Veuillez activer les services de localisation.',
      'snackbar_text_could_not_load_nearby_sitters_please_try_again': 'Impossible de charger les pet sitters à proximité. Veuillez réessayer.',
      ...
      'snackbar_text_failed_to_load_booking_details_using_default_pricing': 'Impossible de charger les détails de réservation. Tarification par défaut utilisée.',
      ...
      'snackbar_text_failed_to_pick_passport_image_please_try_again': 'Impossible de sélectionner l\'image du passeport. Veuillez réessayer.',
      'snackbar_text_failed_to_pick_pet_pictures_or_videos_please_try_again': 'Impossible de sélectionner les photos ou vidéos de l\'animal. Veuillez réessayer.',
      'snackbar_text_failed_to_pick_pet_profile_image_please_try_again': 'Impossible de sélectionner l\'image de profil de l\'animal. Veuillez réessayer.',
      'snackbar_text_failed_to_save_card_please_try_again': 'Impossible d\'enregistrer la carte. Veuillez réessayer.',
      'snackbar_text_failed_to_start_conversation_please_try_again': 'Impossible de démarrer la conversation. Veuillez réessayer.',
      'snackbar_text_failed_to_switch_role_please_try_again': 'Impossible de changer de rôle. Veuillez réessayer.',
      'snackbar_text_height_is_required': 'La taille est requise.',
      'snackbar_text_height_must_be_greater_than_0': 'La taille doit être supérieure à 0.',
      'snackbar_text_hourly_rate_must_be_greater_than_0': 'Le tarif horaire doit être supérieur à 0.',
      'snackbar_text_weekly_rate_must_be_greater_than_0': 'Le tarif hebdomadaire doit être supérieur à 0.',
      'snackbar_text_monthly_rate_must_be_greater_than_0': 'Le tarif mensuel doit être supérieur à 0.',
      ...
      'snackbar_text_image_uploaded_successfully': 'Image téléchargée avec succès !',
      ...
      'snackbar_text_pet_profile_created_but_media_upload_failed_you_can_add_medi': 'Profil de l\'animal créé, mais le téléchargement des médias a échoué. Vous pouvez ajouter des médias plus tard.',
      ...
      'snackbar_text_profile_completed_successfully': 'Profil complété avec succès !',
      ...
      'snackbar_text_unknown_user_role_please_try_again': 'Rôle utilisateur inconnu. Veuillez réessayer.',
      'snackbar_text_verification_code_has_been_resent_to_your_email': 'Le code de vérification a été renvoyé à votre e-mail',
      'snackbar_text_verification_code_resent': 'Code de vérification renvoyé',
    ...
    'block_user_confirm_message': 'Êtes-vous sûr de vouloir bloquer cet utilisateur? Vous ne verrez plus son contenu.',
    'block_user_success': 'Utilisateur bloque avec succès.',
    'block_user_failed': 'Échec du blocage. Veuillez réessayer.',
    'report_post_received': 'Signalement reçu. Merci.',
    'pet_photo_delete_title': 'Supprimer la photo',
    'pet_photo_delete_confirm': 'Voulez-vous vraiment supprimer cette photo?',
    'pet_photo_deleted': 'Photo supprimée avec succès.',
    'pet_photo_delete_failed': 'Échec de la suppression. Veuillez réessayer.',
    'new_publication_button': 'Nouvelle publication',
      ...
      'post_field_service_location_at_sitter': 'Chez le pet-sitter',
    ...
    'report_dialog_details_hint': 'Détails supplémentaires (optionnel)',
    'report_submit_button': 'Envoyer le signalement',
    'report_submit_success': 'Merci, votre signalement a été envoyé.',
    'report_submit_failed': 'Échec de l\'envoi du signalement.',
    ...
    'report_reason_safety': 'Problème de sécurité',
    ...
    'payout_iban_saved_success': 'IBAN enregistré ! En attente de vérification admin avant le premier virement.',
    'payout_method_updated': 'Méthode de versement mise à jour.',
    'payout_iban_verified': '✓ Vérifié',
    ...
    'walker_rate_hint_15': 'Ex : 15',
      ...
      'cancel_72h_dialog_message': 'Tu peux annuler gratuitement car le service est dans plus de 72h. Le propriétaire sera intégralement remboursé.',
    ...
    'service_overnight_stay': 'Nuit chez le pet-sitter',
    ...
    'premium_feature_friends_tracking': 'Amis & famille en direct sur la carte — gratuit ; PawFollow prolonge à 2 h et en arrière-plan',
    ...
    'house_sitting_venue_sitter_home': 'Chez le pet-sitter',
    ...
    'top_walker_achieved': 'Vous êtes Top Promeneur !',
    'top_walker_badge': 'Deviens Top Promeneur',
    'top_walker_progress': '@done / @goal balades · @rating',
    'top_walker_commission_15': 'Commission réduite à 15% — bravo !',
    'top_walker_need_more': 'Encore @walks balades et @rating pour devenir Top Promeneur (15% de commission).',
  ...
  'profile_pref_privacy': 'Confidentialité',
  'profile_pref_hide_map': 'Masquer mon profil sur la carte',
  'profile_pref_hide_map_sub': 'Tu n\'apparais plus sur la PawMap publique. Tes amis continuent de te voir. Tu restes visible dans la recherche.',
  ...
  'pawmap_member_approx': 'Position approximative (à moins de {km} km)',
  'pawmap_member_book': 'Réserver',
  'pawmap_member_price_from': 'dès',
  'pawmap_members_around': '@count membres autour de toi',
  ...
  'pawmap_layer_members': 'Membres',
  'pawmap_share_map_text': 'Regarde cet endroit sur la PawMap HoPetSit :',
  'pawmap_sos_title': 'Envoyer un SOS animal ?',
  'pawmap_sos_body': 'Un signalement prioritaire sera placé à ta position et TOUS les membres HoPetSit dans un rayon de 10 km recevront une notification. À n\'utiliser que pour un animal réellement perdu.',
  'pawmap_sos_send': 'Envoyer le SOS',
  'pawmap_sos_sent_title': 'SOS envoyé',
  'pawmap_sos_sent_msg': '@count membres autour de toi ont été prévenus.',
  'pawmap_sos_cooldown': 'Tu as déjà envoyé un SOS il y a moins d\'une heure.',
  'pawmap_sos_failed': 'Impossible d\'envoyer le SOS. Réessaie.',
  ...
  'update_available_body': 'Une version plus récente de HoPetSit est disponible avec des améliorations et des corrections. Mets-la à jour pour profiter de tout.',
  'update_required_title': 'Mise à jour nécessaire',
  'update_required_body': 'Cette version de HoPetSit n\'est plus prise en charge. Mets l\'app à jour pour continuer.',
  'update_btn_store': 'Mettre à jour',
  'update_btn_later': 'Plus tard',
  'pawmap_btn_around': 'Autour de moi',
  'pawmap_around_title': 'Autour de moi',
  'pawmap_around_subtitle': 'Choisis un rayon, un mode et une catégorie',
  'pawmap_around_km': '{km} km autour',
