...
These Terms & Conditions ("T&C") govern the use of the HopeTSIT platform — mobile app, website, and related services (the "Service") — by any individual or legal entity (the "User").

## 2. Acceptance

By creating an account, accessing or using the Service in any way, the User acknowledges having read, understood and accepted these T&C as well as the Privacy Policy, without reservation. Users who do not agree must stop using the Service.

## 3. Description of the Service

HopeTSIT is a platform that connects:

- **Pet owners** looking for boarding, pet-sitting or dog-walking services
- **Pet-sitters** offering boarding and sitting services
- **Walkers** offering hourly dog-walking services
...
- Provide accurate, complete and up-to-date information when signing up
- Comply with the laws of their jurisdiction and of Hong Kong
...
## 7. Premium subscriptions and paid options

The Service offers Premium subscriptions (monthly or yearly) and one-off paid options (Boost, Map Boost, Chat add-on, etc.). Prices are displayed in the Shop and may vary depending on the chosen currency.

Subscriptions renew automatically at the end of each billing period unless cancelled by the User before the renewal date. Any period started is due in full.

## 8. User behaviour

The following are strictly prohibited:

- Posting illegal, violent, pornographic, hateful, discriminatory or privacy-invasive content
- Harassing, threatening or insulting other Users
- Sharing fraudulent contact details or impersonating others
- Using the Service for commercial activities outside the defined scope
- Mistreating or neglecting animals entrusted via the platform

Any breach may result in immediate account suspension and, where applicable, legal action.
...
- Information or reports posted by Users on the PawMap
- Any service interruption due to force majeure, a failure of a third-party provider (Stripe, hosting, etc.), or action by public authorities
...
These T&C are governed by the laws of the Hong Kong Special Administrative Region. Any dispute relating to their interpretation or enforcement falls under the exclusive jurisdiction of the Hong Kong courts, unless overridden by a mandatory provision of the consumer's jurisdiction of residence.
