...
I presenti Termini e Condizioni ("T&C") regolano l'utilizzo della piattaforma HopeTSIT — applicazione mobile, sito web e servizi associati ("Servizio") — da parte di qualsiasi persona fisica o giuridica ("Utente").

## 2. Accettazione

Creando un account, accedendo o utilizzando il Servizio in qualsiasi modo, l'Utente riconosce di aver letto, compreso e accettato senza riserve i presenti T&C e l'Informativa sulla Privacy. L'Utente che non accetta dovrà smettere di utilizzare il Servizio.

## 3. Descrizione del Servizio

HopeTSIT è una piattaforma che mette in contatto:

- **Proprietari di animali** in cerca di servizi di custodia, pensione o passeggiata
- **Pet-sitter** che offrono servizi di custodia e pensione
- **Dog-walker** che offrono servizi di passeggiata a ore
...
Per utilizzare il Servizio, l'Utente deve:

- Avere almeno 18 anni
- Avere la capacità giuridica di contrattare
- Fornire informazioni accurate, complete e aggiornate al momento della registrazione
- Rispettare le leggi della propria giurisdizione e quelle di Hong Kong
...
## 7. Abbonamenti Premium e opzioni a pagamento

Il Servizio offre abbonamenti Premium (mensili o annuali) e opzioni a pagamento una tantum (Boost, Map Boost, Chat add-on, ecc.). I prezzi sono visualizzati nel Negozio e possono variare a seconda della valuta scelta.

Gli abbonamenti si rinnovano automaticamente alla fine di ogni periodo di fatturazione salvo disdetta da parte dell'Utente dal proprio spazio personale prima della data di rinnovo. Ogni periodo iniziato è dovuto per intero.

## 8. Comportamento degli utenti

È severamente vietato:

- Pubblicare contenuti illegali, violenti, pornografici, d'odio, discriminatori o lesivi della privacy altrui
- Molestare, minacciare o insultare altri Utenti
- Diffondere recapiti fraudolenti o usurpare l'identità altrui
- Utilizzare il Servizio per attività commerciali al di fuori del quadro definito
- Maltrattare o trascurare animali affidati tramite la piattaforma

Qualsiasi violazione espone l'Utente alla sospensione immediata dell'account e, se del caso, ad azioni legali.
...
- Le informazioni o segnalazioni pubblicate dagli Utenti sulla PawMap
- Qualsiasi interruzione del Servizio dovuta a cause di forza maggiore, guasto di un fornitore terzo (Stripe, hosting, ecc.) o azione delle autorità
...
I presenti T&C sono soggetti al diritto della Regione Amministrativa Speciale di Hong Kong. Qualsiasi controversia è di competenza esclusiva dei tribunali di Hong Kong, salvo disposizioni imperative a tutela del consumatore nella giurisdizione di residenza.

## 13. Contatto

Per qualsiasi domanda sui presenti T&C o sul Servizio, l'Utente può contattare: support@hopetsit.com
