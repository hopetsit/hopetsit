# Conditions Générales d'Utilisation — HopeTSIT
...
Les présentes Conditions Générales d'Utilisation (ci-après « CGU ») régissent l'utilisation de la plateforme HopeTSIT — application mobile, site web et services associés (ci-après « le Service ») — par toute personne physique ou morale (ci-après « l'Utilisateur »).

## 2. Acceptation des CGU

En créant un compte, en accédant au Service ou en l'utilisant de quelque manière que ce soit, l'Utilisateur reconnaît avoir lu, compris et accepté sans réserve les présentes CGU ainsi que la Politique de Confidentialité. Si l'Utilisateur n'accepte pas ces conditions, il doit renoncer à utiliser le Service.

## 3. Description du Service

HopeTSIT est une plateforme de mise en relation entre :

- **Propriétaires d'animaux** cherchant des prestations de garde, de pension ou de promenade pour leur animal
- **Pet-sitters** proposant des services de garde et de pension
- **Promeneurs (walkers)** proposant des services de promenade à l'heure
...
- Disposer de la capacité juridique de contracter
- Fournir des informations exactes, complètes et à jour lors de son inscription
- Respecter les lois en vigueur dans sa juridiction ainsi qu'à Hong Kong
...
## 7. Abonnements Premium et options payantes

Le Service propose des abonnements Premium (mensuel ou annuel) et des options payantes ponctuelles (Boost, Map Boost, Chat add-on, etc.). Les tarifs sont affichés dans la Boutique et peuvent varier selon la devise choisie.

Les abonnements sont reconduits tacitement à la fin de chaque période de facturation sauf résiliation par l'Utilisateur depuis son espace personnel avant la date d'échéance. Toute période entamée est due.

## 8. Comportement des utilisateurs

Il est strictement interdit de :

- Publier des contenus illégaux, violents, pornographiques, haineux, discriminatoires ou portant atteinte à la vie privée d'autrui
- Harceler, menacer ou insulter d'autres Utilisateurs
- Diffuser des coordonnées frauduleuses ou usurper l'identité d'autrui
- Utiliser le Service pour des activités commerciales en dehors du cadre défini
- Maltraiter ou négliger des animaux confiés via la plateforme

Tout manquement expose l'Utilisateur à la suspension immédiate de son compte, voire à des poursuites judiciaires.
...
- Des informations ou signalements postés par les Utilisateurs sur la PawMap
- De toute rupture de service due à un cas de force majeure, une panne d'un prestataire tiers (Stripe, hébergement, etc.) ou une action des autorités
...
Les présentes CGU sont soumises au droit de la Région Administrative Spéciale de Hong Kong. Tout litige relatif à leur interprétation ou à leur exécution relève de la compétence exclusive des tribunaux de Hong Kong, sauf disposition légale impérative contraire dans la juridiction de résidence du consommateur.
