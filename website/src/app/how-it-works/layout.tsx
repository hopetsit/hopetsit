// 24/09/2026 — LOT B, étape 5 : titre et description propres de /how-it-works, servis
...
export const metadata: Metadata = pageMeta("page_title_how", "page_desc_how", "/how-it-works");
