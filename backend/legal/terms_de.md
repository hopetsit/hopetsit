# Allgemeine Geschäftsbedingungen — HopeTSIT
...
Diese Allgemeinen Geschäftsbedingungen („AGB") regeln die Nutzung der HopeTSIT-Plattform — Mobile App, Website und zugehörige Dienste („Dienst") — durch natürliche oder juristische Personen („Nutzer").

## 2. Annahme

Mit der Erstellung eines Kontos, dem Zugriff oder der Nutzung des Dienstes in irgendeiner Form bestätigt der Nutzer, diese AGB sowie die Datenschutzerklärung gelesen, verstanden und vorbehaltlos akzeptiert zu haben. Nutzer, die nicht einverstanden sind, müssen den Dienst nicht mehr nutzen.

## 3. Beschreibung des Dienstes

HopeTSIT ist eine Plattform, die verbindet:

- **Tierhalter**, die Betreuungs-, Pensions- oder Gassiservice-Dienste suchen
- **Tierbetreuer (Sitter)**, die Betreuungs- und Pensionsdienste anbieten
- **Hundeausführer (Walker)**, die stündliche Gassidienste anbieten
...
Zur Nutzung des Dienstes muss der Nutzer:

- mindestens 18 Jahre alt sein
- rechtsfähig sein
- bei der Anmeldung genaue, vollständige und aktuelle Informationen angeben
- die Gesetze seiner Gerichtsbarkeit und Hongkongs einhalten
...
## 7. Premium-Abonnements und kostenpflichtige Optionen

Der Dienst bietet Premium-Abonnements (monatlich oder jährlich) sowie einmalige kostenpflichtige Optionen (Boost, Map Boost, Chat Add-on usw.). Die Preise werden im Shop angezeigt und können je nach gewählter Währung variieren.

Abonnements verlängern sich automatisch am Ende jedes Abrechnungszeitraums, sofern sie nicht vor dem Verlängerungsdatum durch den Nutzer gekündigt werden. Jede begonnene Periode wird in voller Höhe berechnet.

## 8. Nutzerverhalten

Folgendes ist strikt untersagt:

- Veröffentlichung illegaler, gewalttätiger, pornografischer, hasserfüllter, diskriminierender oder die Privatsphäre verletzender Inhalte
- Belästigung, Bedrohung oder Beleidigung anderer Nutzer
- Verbreitung betrügerischer Kontaktdaten oder Identitätsdiebstahl
- Nutzung des Dienstes für kommerzielle Aktivitäten außerhalb des definierten Rahmens
- Misshandlung oder Vernachlässigung von über die Plattform anvertrauten Tieren

Verstöße können zur sofortigen Kontosperrung und ggf. zu rechtlichen Schritten führen.
...
- Von Nutzern auf der PawMap veröffentlichte Informationen oder Meldungen
- Dienstunterbrechungen aufgrund höherer Gewalt, Ausfall eines Drittanbieters (Stripe, Hosting usw.) oder behördlicher Maßnahmen
...
Diese AGB unterliegen dem Recht der Sonderverwaltungsregion Hongkong. Streitigkeiten unterliegen der ausschließlichen Zuständigkeit der Gerichte von Hongkong, es sei denn, zwingende Verbraucherschutzvorschriften am Wohnsitz des Nutzers bestimmen anderes.

## 13. Kontakt

Bei Fragen zu diesen AGB oder zum Dienst kontaktieren Sie bitte: support@hopetsit.com
