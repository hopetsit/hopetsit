...
/// v23.1 part 27 — REVERT à la nav bar PILL FLOTTANTE qui marchait avant.
/// Daniel a confirmé qu'avant les refactors récents, ça marchait très bien.
/// On restaure : Container(margin + borderRadius + boxShadow), pas de
/// Stack/Material custom, le Scaffold parent gère l'inset via bottomNavigationBar.
...
class CustomNavigationBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Pill flottante avec margins → ne touche PAS les bords de l'écran,
    // donc plus aucun risque de "rectangle gris" dans la zone système.
    return Container(
      height: 78.h,
                ...
                if (badgeIndex != null)
                  Positioned(
                    ...
                    child: Obx(() {
                      ...
                      final nc = Get.find<NotificationsController>();
                      // home tab badge suppressed (only chat &
