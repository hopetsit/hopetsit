...
const Map<String, String> ptPTTranslations = <String, String>{
    ...
    // v23.1 part 117 — chaves em falta (existiam em EN, agora em PT).
    ...
    'auth_role_required': 'Papel obrigatório',
    'auth_role_required_message': 'Contacta o suporte para configurar o teu papel.',
    'auth_welcome': 'Bem-vindo!',
    'booking_agreement_load_error': 'Não foi possível carregar o acordo. Tenta novamente.',
    'card_save_failed': 'Falha ao guardar o cartão. Tenta novamente.',
    'card_save_success': 'Cartão guardado com sucesso!',
    'comment_add_failed': 'Falha ao adicionar o comentário. Tenta novamente.',
    'comment_add_success': 'Comentário adicionado com sucesso!',
    'edit_profile_image_pick_failed': 'Falha ao selecionar imagem. Tenta novamente.',
    ...
    'edit_profile_location_error': 'Falha ao obter a tua localização. Tenta novamente.',
    'home_block_failed': 'Bloqueio falhou',
    'home_block_failed_generic': 'Algo correu mal. Tenta novamente.',
    'home_block_success': 'Utilizador bloqueado com sucesso',
    'home_image_pick_failed': 'Falha ao selecionar imagens. Tenta novamente.',
    'onboarding_profile_complete_failed': 'Falha ao completar o perfil. Tenta novamente.',
    'onboarding_profile_complete_success': 'Perfil completado com sucesso!',
    'onboarding_terms_required': 'Aceita os Termos e Condições',
    'otp_complete_code_required': 'Introduz o código completo de 6 dígitos.',
    'otp_login_again': 'Volta a iniciar sessão',
    'otp_verification_success': 'Verificação bem-sucedida!',
    'payment_pay_with_card': 'Pagar @amount',
    'pet_create_failed': 'Falha ao criar o perfil do animal. Tenta novamente.',
    'pet_create_success': 'Perfil do animal criado com sucesso!',
    'pet_create_validation_error_message': 'Preenche todos os campos obrigatórios',
    'pet_image_pick_failed': 'Falha ao selecionar imagem. Tenta novamente.',
    'pet_load_error': 'Falha ao carregar os dados do animal. Tenta novamente.',
    'pet_media_pick_failed': 'Falha ao selecionar média. Tenta novamente.',
    'pet_passport_image_pick_failed': 'Falha ao selecionar foto do passaporte. Tenta novamente.',
    'pet_profile_image_pick_failed': 'Falha ao selecionar foto de perfil. Tenta novamente.',
    'pet_update_failed_generic': 'Algo correu mal. Tenta novamente.',
    'pet_update_success': 'Perfil do animal atualizado com sucesso!',
    'pet_validation_error_message': 'Preenche todos os campos obrigatórios',
    'posts_load_error': 'Falha ao carregar as publicações. Tenta novamente.',
    'service_selected_message': 'Serviço selecionado',
    'service_selection_failed': 'Seleção falhou',
    'service_selection_failed_generic': 'Algo correu mal. Tenta novamente.',
    'service_selection_required_at_least_one': 'Seleciona pelo menos um serviço',
    'service_selection_required_message': 'Seleciona um serviço',
    'service_selection_required_single': 'Seleciona um serviço',
    'service_updated_message': 'Os teus serviços foram atualizados',
    'signup_failed_generic': 'Algo correu mal. Tenta novamente.',
    'signup_location_error': 'Falha ao obter a tua localização. Tenta novamente.',
