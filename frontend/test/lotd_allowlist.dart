...
const Map<String, int> kGrayColorsAllowed = <String, int>{
  'lib/services/airwallex_payment_service.dart': 2,
  'lib/services/friend_marker_service.dart': 1,
  'lib/utils/app_colors.dart': 8,
  'lib/utils/pawmap_theme.dart': 3,
  'lib/views/auth/login_screen.dart': 5,
  'lib/views/booking/widgets/booking_ui_kit.dart': 2,
  'lib/views/boost/coin_shop_screen.dart': 4,
  'lib/views/chat_shared/chat_avatar.dart': 1,
  'lib/views/chat_shared/chat_theme.dart': 1,
  'lib/views/map/paw_map_screen.dart': 2,
  'lib/views/map/pets_map_screen.dart': 2,
  'lib/views/map/report_category_grid_screen.dart': 4,
  'lib/views/map/widgets/paw_rail_button.dart': 2,
  'lib/views/map/widgets/pawmap_rail.dart': 4,
  'lib/views/onboarding/onboarding_screen.dart': 3,
  'lib/views/pet_owner/pet_profile/pet_gallery_screen.dart': 1,
  'lib/views/pet_owner/pet_profile/pet_profile_screen.dart': 1,
  'lib/views/pet_sitter/payment/earnings_history_screen.dart': 2,
  'lib/views/pet_sitter/widgets/pet_post_card.dart': 1,
  'lib/views/pet_walker/profile/walker_profile_screen.dart': 1,
  'lib/views/profile/edit_pet_screen.dart': 1,
  'lib/views/profile/widgets/profile_categories.dart': 1,
  'lib/views/profile/widgets/profile_hero.dart': 1,
  'lib/views/profile/widgets/profile_settings_tabs.dart': 1,
  'lib/views/service_provider/send_request_screen.dart': 1,
  'lib/views/shared/availability_calendar_screen.dart': 2,
  'lib/widgets/app_switch.dart': 3,
  'lib/widgets/boost_profile_card.dart': 1,
  'lib/widgets/chat_access_upsell_helper.dart': 1,
  'lib/widgets/custom_confirmation_dialog.dart': 1,
  'lib/widgets/custom_navigation_bar.dart': 1,
  'lib/widgets/custom_snackbar_widget.dart': 2,
  'lib/widgets/paw_tab_bar.dart': 1,
  'lib/widgets/paypal_email_dialog.dart': 1,
  'lib/widgets/report_dialog.dart': 1,
};
