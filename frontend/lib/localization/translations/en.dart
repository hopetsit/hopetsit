...
const Map<String, String> enUSTranslations = <String, String>{
    ...
    'edit_pet_color_hint': 'Enter the color',
    'edit_pet_passport_label': 'Passport number',
    'edit_pet_passport_hint': 'Enter the number',
    'edit_pet_chip_label': 'Chip number',
    'edit_pet_chip_hint': 'Enter the number',
    'edit_pet_medication_label': 'Allergies / medication',
    'edit_pet_medication_hint': 'Enter allergies or medication',
    'shop_tile_boost': 'Boost',
    'shop_tile_premium': 'Premium',
    'shop_tile_map_boost': 'Map Boost',
    'my_rates_walker_hint': 'Adjust your rates for 30 min and 60 min walks.',
    'my_rates_sitter_hint': 'Adjust your daily, weekly, and monthly rates.',
    'paypal_email_optional': 'PayPal email (optional)',
    'boost_popular': 'POPULAR',
    'boost_status_active': 'Boost active!',
    'boost_status_inactive': 'No active boost',
    'boost_remaining_days': '@days days remaining',
    'boost_inactive_hint': 'Buy a boost to appear first',
    'boost_how_title': 'How does it work?',
    'boost_step_1': 'Choose your boost package',
    'boost_step_2': 'Pay securely by card',
    'boost_step_3': 'Your profile moves to the top of the feed',
    'boost_step_4': 'More visibility = more requests',
    'boost_history_title': 'Purchase history',
    'boost_purchase_success_title': 'Boost activated!',
    'boost_purchase_success_msg': 'Your profile is now boosted to the top of the feed!',
    'boost_purchase_error': 'Error purchasing boost.',
    'boost_service_unavailable': 'This service is not yet available. Coming soon!',
