...
const Map<String, String> frFRTranslations = <String, String>{
    ...
    'edit_pet_color_hint': 'Entre la couleur',
    'edit_pet_passport_label': 'Numéro de passeport',
    'edit_pet_passport_hint': 'Entre le numéro',
    'edit_pet_chip_label': 'Numéro de puce',
    'edit_pet_chip_hint': 'Entre le numéro',
    'edit_pet_medication_label': 'Allergies / traitements',
    'edit_pet_medication_hint': 'Entre les allergies ou traitements',
    'shop_tile_boost': 'Boost',
    'shop_tile_premium': 'Premium',
    'shop_tile_map_boost': 'Map Boost',
    'my_rates_walker_hint': 'Ajuste tes tarifs pour 30 min et 60 min de balade.',
    'my_rates_sitter_hint': 'Ajuste tes tarifs journalier, hebdomadaire et mensuel.',
    'paypal_email_optional': 'E-mail PayPal (optionnel)',
    'boost_popular': 'POPULAIRE',
    'boost_status_active': 'Boost actif !',
    'boost_status_inactive': 'Pas de boost actif',
    'boost_remaining_days': '@days jours restants',
    'boost_inactive_hint': 'Achetez un boost pour apparaître en premier',
    'boost_how_title': 'Comment ça marche ?',
    'boost_step_1': 'Choisissez votre forfait boost',
    'boost_step_2': 'Payez en toute sécurité par carte',
    'boost_step_3': 'Votre profil remonte en tête du feed',
    'boost_step_4': 'Plus de visibilité = plus de demandes',
    'boost_history_title': 'Historique des achats',
