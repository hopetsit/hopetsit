...
const Map<String, String> ptPTTranslations = <String, String>{
    ...
    'edit_pet_color_hint': 'Introduz a cor',
    'edit_pet_passport_label': 'Número de passaporte',
    'edit_pet_passport_hint': 'Introduz o número',
    'edit_pet_chip_label': 'Número do chip',
    'edit_pet_chip_hint': 'Introduz o número',
    'edit_pet_medication_label': 'Alergias / medicação',
    'edit_pet_medication_hint': 'Introduz alergias ou medicação',
    'shop_tile_boost': 'Boost',
    'shop_tile_premium': 'Premium',
    'shop_tile_map_boost': 'Map Boost',
    'my_rates_walker_hint': 'Ajusta as tuas tarifas para passeios de 30 min e 60 min.',
    'my_rates_sitter_hint': 'Ajusta as tarifas diária, semanal e mensal.',
    'boost_popular': 'POPULAR',
    'boost_status_active': 'Boost ativo!',
    'boost_status_inactive': 'Sem boost ativo',
    'boost_remaining_days': '@days dias restantes',
    'boost_inactive_hint': 'Compre um boost para aparecer primeiro',
    'boost_how_title': 'Como funciona?',
    'boost_step_1': 'Escolha o seu pacote boost',
    'boost_step_2': 'Pague com segurança por cartão',
    'boost_step_3': 'O seu perfil sobe ao topo do feed',
    'boost_step_4': 'Mais visibilidade = mais pedidos',
    'boost_history_title': 'Histórico de compras',
    'boost_purchase_success_title': 'Boost ativado!',
    'boost_purchase_success_msg': 'O seu perfil está agora em destaque!',
    'boost_purchase_error': 'Erro ao comprar boost.',
    'boost_service_unavailable': 'Este serviço ainda não está disponível. Em breve!',
    ...
    'role_pet_walker_desc': 'Candidata-te aos passeios remunerados publicados pelos donos. E se também tens um animal, o PawMap ajuda-te a encontrar veterinários, pontos de água e lugares úteis.',
    'sign_up_as_pet_walker': 'Registar como passeador',
    'auth_role_pet_walker': 'Passeador',
    'walker_home_title': 'Início Passeador',
    'walker_home_welcome_title': 'Bem-vindo, Passeador!',
    'walker_home_welcome_body': 'Configure as suas tarifas e zona de cobertura para começar a receber pedidos de passeio.',
    'walker_home_coming_soon': 'Funcionalidades dedicadas aos passeadores chegam muito em breve.',
    'walker_profile_title': 'O meu perfil',
    'walker_profile_welcome': 'Perfil de passeador',
    'walker_profile_subtitle': 'Gerencie o seu perfil, tarifas e disponibilidade',
    'walker_profile_coming_soon': 'Edição de perfil em breve.',
};
