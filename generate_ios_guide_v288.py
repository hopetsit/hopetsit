"""HopeTSIT iOS Build Guide v23.1.288 generator."""
...
OUT = "C:/Users/Usuario/Downloads/HopeTSIT_iOS_Build_Guide_v23.1.288.pdf"
doc = SimpleDocTemplate(OUT, pagesize=A4, leftMargin=1.8*cm, rightMargin=1.8*cm,
    topMargin=1.8*cm, bottomMargin=1.8*cm, title="HopeTSIT iOS Build Guide v23.1.288", author="HopeTSIT team")
...
flow.append(Paragraph("Version 23.1.288 (Build 288)", H2))
...
flow.append(Paragraph(
    "v23.1.288 &mdash; Frontend (PawMap) + backend (schema Post, scheduler "
...
flow.append(Paragraph("Changelog v23.1.288", H1))
...
flow.append(Spacer(1, 0.5*cm))
flow.append(Paragraph("Build Android : flutter build apk --release -&gt; Downloads/HopeTSit_v288.apk.", INFO))
